import { $n as sha384, A as toHex$2, An as fromString$1, B as assert$3, Bn as isAddressEqual, C as toRpcList$1, Cn as toBigInt, Cs as hexToBytes, D as fromHex$1, Dn as validate$1, E as from$5, En as trimLeft, Es as toBytes$1, Et as sendTransaction, F as createCurve, Fs as hexToNumber$1, G as fromHex$3, H as fromPublicKey, I as Field, J as sha256$2, K as toHex$1, Kn as getTransactionType, L as fromHex$2, Ln as parseEventLogs, Ls as trim, M as toTuple$2, Mn as stringify, N as yParityToV, Nn as BaseError$1, Ns as hexToBigInt, O as fromRpc$5, Oa as toRlp, On as concat, Qn as sha256$1, R as toHex$3, S as fromRpcList$1, Sa as TipAboveFeeCapError$1, Sn as slice, St as formatTransactionReceipt$1, T as extract$1, Tc as getAction, Tn as toString, Tt as writeContract, U as isEqual$1, Us as pad, Ut as getCallError, V as checksum, W as validate$2, Xt as InvalidChainIdError$1, Y as validate, Yo as encodeFunctionData, Zn as sha256, Zo as parseAccount, _n as fromBytes, _s as InvalidAddressError, b as recoverPublicKey, bc as BaseError, bn as random, bt as getCode, ca as defineTransactionRequest, d as getSelector, da as extract, dr as defineTransaction, er as sha512, fr as formatTransaction$1, fs as concatHex, ft as defineChain, gn as from$4, gt as serializeAccessList, hn as concat$1, ht as toYParitySignatureArray, ii as maxUint16, j as toRpc$5, jn as isEqual, js as toHex, k as fromTuple$2, kn as fromHex, ks as numberToHex$1, kt as AccountNotFoundError, la as formatTransactionRequest$1, lr as defineBlock, ma as FeeCapTooHighError$1, mn as assert$2, mt as serializeTransaction$3, o as verifyHash$1, ps as isAddress, pt as extendSchema, q as keccak256, vi as maxUint256, vn as fromNumber, vr as assertRequest, w as assert$1, wn as toNumber, x as verify$4, xn as size, xs as keccak256$1, xt as defineTransactionReceipt, y as recoverAddress, yn as fromString, zn as formatLog, zt as readContract } from "./writeContractSync-LaZFPBJH.js";
//#region node_modules/viem/_esm/chains/definitions/0g.js
var zeroG = /*#__PURE__*/ defineChain({
	id: 16600,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/0gGalileoTestnet.js
var zeroGGalileoTestnet = /*#__PURE__*/ defineChain({
	id: 16601,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/0gMainnet.js
var zeroGMainnet = /*#__PURE__*/ defineChain({
	id: 16661,
	name: "0G Mainnet",
	nativeCurrency: {
		name: "0G",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/0gTestnet.js
var zeroGTestnet = /*#__PURE__*/ defineChain({
	id: 16602,
	name: "0G Galileo Testnet",
	nativeCurrency: {
		name: "A0GI",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/5ireChain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/abey.js
...
//#endregion
//#region node_modules/viem/_esm/zksync/constants/number.js
var gasPerPubdataDefault = 50000n;
var maxBytecodeSize = maxUint16 * 32n;
//#endregion
//#region node_modules/viem/_esm/zksync/formatters.js
var formatters$2 = {
	block: /*#__PURE__*/ defineBlock({ format(args) {
		const transactions = args.transactions?.map((transaction) => {
			if (typeof transaction === "string") return transaction;
			const formatted = formatters$2.transaction?.format(transaction);
		...
		return {
			...
			logs: args.logs.map((log) => {
				return {
					...
					transactionLogIndex: hexToNumber$1(log.transactionLogIndex),
					logType: log.logType
				};
			}),
		...
		format(args) {
			if (args.gasPerPubdata || args.paymaster && args.paymasterInput || args.factoryDeps || args.customSignature) return {
				eip712Meta: {
					...
					...args.paymaster && args.paymasterInput ? { paymasterParams: {
						paymaster: args.paymaster,
						paymasterInput: Array.from(hexToBytes(args.paymasterInput))
					} } : {},
					...args.factoryDeps ? { factoryDeps: args.factoryDeps.map((dep) => Array.from(hexToBytes(dep))) } : {},
					...args.customSignature ? { customSignature: Array.from(hexToBytes(args.customSignature)) } : {}
				},
				type: "0x71"
			};
			return {};
...
//#endregion
//#region node_modules/viem/_esm/zksync/errors/transaction.js
...
//#endregion
//#region node_modules/viem/_esm/zksync/utils/isEip712Transaction.js
...
//#endregion
//#region node_modules/viem/_esm/zksync/utils/assertEip712Transaction.js
function assertEip712Transaction(transaction) {
	...
	if (!chainId || chainId <= 0) throw new InvalidChainIdError$1({ chainId });
	if (to && !isAddress(to)) throw new InvalidAddressError({ address: to });
	if (from && !isAddress(from)) throw new InvalidAddressError({ address: from });
	if (paymaster && !isAddress(paymaster)) throw new InvalidAddressError({ address: paymaster });
	if (paymaster && !paymasterInput) throw new BaseError("`paymasterInput` must be provided when `paymaster` is defined");
	if (!paymaster && paymasterInput) throw new BaseError("`paymaster` must be provided when `paymasterInput` is defined");
}
//#endregion
...
var serializers$2 = { transaction: serializeTransaction$2 };
function serializeTransactionEIP712(transaction) {
	const { chainId, gas, nonce, to, from, value, maxFeePerGas, maxPriorityFeePerGas, customSignature, factoryDeps, paymaster, paymasterInput, gasPerPubdata, data } = transaction;
	assertEip712Transaction(transaction);
	return concatHex(["0x71", toRlp([
...
//#endregion
//#region node_modules/viem/_esm/zksync/errors/bytecode.js
...
//#endregion
//#region node_modules/viem/_esm/zksync/utils/getEip712Domain.js
...
function transactionToMessage(transaction) {
	...
	return {
		...
		to: to ? BigInt(to) : 0n,
		gasLimit: gas ?? 0n,
		gasPerPubdataByteLimit: gasPerPubdata ?? 50000n,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/abstract.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/abstractTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/acala.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/acria.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/adf.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/adi.js
var adi = /*#__PURE__*/ defineChain({
	id: 36900,
	name: "ADI_Chain",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/agungTestnet.js
var agungTestnet = /*#__PURE__*/ defineChain({
	id: 9990,
	name: "Agung Network",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/aioz.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/alephZero.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/alephZeroTestnet.js
var alephZeroTestnet = /*#__PURE__*/ defineChain({
	id: 2039,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/alienX.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/alienXHalTestnet.js
var alienxHalTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://hal-rpc.alienxchain.io/http"] } },
	blockExplorers: { default: {
		name: "AlienX Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/alpenTestnet.js
var alpenTestnet = /*#__PURE__*/ defineChain({
	id: 8150,
	name: "Alpen Testnet",
	nativeCurrency: {
		name: "Signet BTC",
	...
	rpcUrls: { default: { http: ["https://rpc.testnet.alpenlabs.io"] } },
	blockExplorers: { default: {
		name: "Alpen Explorer",
	...
	block: /*#__PURE__*/ defineBlock({ format(args) {
		return {
			transactions: args.transactions?.map((transaction) => {
				if (typeof transaction === "string") return transaction;
				const formatted = formatTransaction$1(transaction);
...
var serializers$1 = { transaction: serializeTransaction$1 };
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ancient8.js
var sourceId$68 = 1;
var ancient8 = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$68]: { address: "0xB09DC08428C8b4EFB4ff9C0827386CDF34277996" } },
		portal: { [sourceId$68]: {
			address: "0x639F2AECE398Aa76b07e59eF6abe2cFe32bacb68",
			blockCreated: 19070571
		} },
		l1StandardBridge: { [sourceId$68]: {
			address: "0xd5e3eDf5b68135D559D572E26bF863FBC1950033",
			blockCreated: 19070571
		} }
	},
	sourceId: sourceId$68
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ancient8Sepolia.js
var sourceId$67 = 11155111;
var ancient8Sepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$67]: { address: "0x942fD5017c0F60575930D8574Eaca13BEcD6e1bB" } },
		portal: { [sourceId$67]: {
			address: "0xfa1d9E26A6aCD7b22115D27572c1221B9803c960",
			blockCreated: 4972908
		} },
		l1StandardBridge: { [sourceId$67]: {
			address: "0xF6Bc0146d3c74D48306e79Ae134A260E418C9335",
			blockCreated: 4972908
		} }
	},
	sourceId: sourceId$67,
	testnet: true
});
//#endregion
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/apexTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/apollo.js
var apollo = /*#__PURE__*/ defineChain({
	id: 62606,
	name: "Apollo",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://mainnet-rpc.apolloscan.io"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/arbitrumGoerli.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/arbitrumNova.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/arc.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/arcTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/arenaz.js
var arenaz = /*#__PURE__*/ defineChain({
	id: 7897,
	name: "Arena-Z",
	nativeCurrency: {
		name: "Ether",
	...
	rpcUrls: { default: { http: ["https://rpc.arena-z.gg"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/areonNetwork.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/areonNetworkTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/areum.js
var areum = /*#__PURE__*/ defineChain({
	id: 463,
	name: "Areum",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/artelaTestnet.js
var artelaTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://betanet-rpc1.artela.network"] } },
	blockExplorers: { default: {
		name: "Artela",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/arthera.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/artheraTestnet.js
var artheraTestnet = /*#__PURE__*/ defineChain({
	id: 10243,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/assetChain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/assetChainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/astar.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/astarZkEVM.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/astarZkyoto.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/atletaOlympia.js
var atletaOlympia = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: {
		http: ["https://testnet-rpc.atleta.network:9944", "https://testnet-rpc.atleta.network"],
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/aurora.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/auroraTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/auroria.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/autheoTestnet.js
var autheoTestnet = /*#__PURE__*/ defineChain({
	id: 785,
	name: "Autheo Testnet",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://testnet-rpc1.autheo.com", "https://testnet-rpc2.autheo.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/avalancheFuji.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bahamut.js
...
var base = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$63]: { address: "0x43edB88C4B80fDD2AdFF2412A7BebF9dF42cB40e" } },
		l2OutputOracle: { [sourceId$63]: { address: "0x56315b90c40730925ec5485cf004d835058518A0" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 5022
		},
		...
		l1StandardBridge: { [sourceId$63]: {
			address: "0x3154Cf16ccdb4C6d922629664174b904d80F2C35",
			blockCreated: 17482143
		} }
	},
	sourceId: sourceId$63
});
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/basecampTestnet.js
var basecampTestnet = /*#__PURE__*/ defineChain({
	id: 123420001114,
	...
	rpcUrls: { default: { http: ["https://rpc.basecamp.t.raas.gelato.cloud"] } },
	blockExplorers: { default: {
		name: "basecamp",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/baseGoerli.js
var sourceId$62 = 5;
var baseGoerli = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$62]: { address: "0x2A35891ff30313CcFa6CE88dcf3858bb075A2298" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 1376988
		},
		portal: { [sourceId$62]: { address: "0xe93c8cD0D409341205A592f8c4Ac1A5fe5585cfA" } },
		l1StandardBridge: { [sourceId$62]: { address: "0xfA6D8Ee5BE770F84FC001D098C4bD604Fe01284a" } }
	},
	testnet: true,
	sourceId: sourceId$62
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/baseSepolia.js
var sourceId$61 = 11155111;
var baseSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$61]: { address: "0xd6E6dBf4F7EA0ac412fD8b65ED297e64BB7a06E1" } },
		l2OutputOracle: { [sourceId$61]: { address: "0x84457ca9D0163FbC4bbfe4Dfbb20ba46e48DF254" } },
		portal: { [sourceId$61]: {
			address: "0x49f53e41452c74589e85ca1677426ba426459e85",
			blockCreated: 4446677
		} },
		l1StandardBridge: { [sourceId$61]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/battlechainTestnet.js
var battlechainTestnet = /*#__PURE__*/ defineChain({
	...chainConfig$4,
	id: 627,
	...
	rpcUrls: { default: { http: ["https://testnet.battlechain.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/beam.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/beamTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bearNetworkChainMainnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bearNetworkChainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/berachainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/berachainTestnetbArtio.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bevmMainnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bifrost.js
var bifrost = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://public-01.mainnet.bifrostnetwork.com/rpc"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/birdlayer.js
var birdlayer = /*#__PURE__*/ defineChain({
	id: 53456,
	name: "BirdLayer",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bitgert.js
var bitgert = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc-bitgert.icecreamswap.com"] } },
	blockExplorers: { default: {
		name: "Bitgert Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bitkub.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bitkubTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bitlayer.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bitlayerTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bitrock.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bitTorrent.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bitTorrentTestnet.js
var bitTorrentTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://testrpc.bittorrentchain.io"] } },
	blockExplorers: { default: {
		name: "Bttcscan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/blast.js
var sourceId$60 = 1;
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bob.js
var sourceId$58 = 1;
var bob = /*#__PURE__*/ defineChain({
	...
	sourceId: sourceId$58
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/boba.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bobaSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bobSepolia.js
var sourceId$57 = 11155111;
var bobSepolia = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	id: 808813,
	name: "BOB Sepolia",
	nativeCurrency: {
	...
	testnet: true,
	sourceId: sourceId$57
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/boolBetaMainnet.js
var boolBetaMainnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://beta-rpc-node-http.bool.network"] } },
	blockExplorers: { default: {
		name: "BoolScan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/botanix.js
var botanix = /*#__PURE__*/ defineChain({
	id: 3637,
	name: "Botanix",
	nativeCurrency: {
		name: "Bitcoin",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/botanixTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bounceBit.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bounceBitTestnet.js
var bounceBitTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://fullnode-testnet.bouncebitapi.com"] } },
	blockExplorers: { default: {
		name: "BB Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bronos.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bronosTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bscGreenfield.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bscTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bsquared.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bsquaredTestnet.js
var bsquaredTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://testnet-rpc.bsquared.network"] } },
	blockExplorers: { default: {
		name: "blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/btr.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/btrTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bxn.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/bxnTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/cannon.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/canto.js
...
var formatters = {
	block: /*#__PURE__*/ defineBlock({ format(args) {
		return { transactions: args.transactions?.map((transaction) => {
			if (typeof transaction === "string") return transaction;
			return {
				...formatTransaction$1(transaction),
...
function assertTransactionCIP64(transaction) {
	...
	if (chainId <= 0) throw new InvalidChainIdError$1({ chainId });
	if (to && !isAddress(to)) throw new InvalidAddressError({ address: to });
	if (gasPrice) throw new BaseError("`gasPrice` is not a valid CIP-64 Transaction attribute.");
	if (isPresent(maxFeePerGas) && maxFeePerGas > MAX_MAX_FEE_PER_GAS) throw new FeeCapTooHighError$1({ maxFeePerGas });
	if (isPresent(maxPriorityFeePerGas) && isPresent(maxFeePerGas) && maxPriorityFeePerGas > maxFeePerGas) throw new TipAboveFeeCapError$1({
		maxFeePerGas,
		maxPriorityFeePerGas
	});
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/celoAlfajores.js
var sourceId$56 = 17e3;
var celoAlfajores = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$56]: {
			address: "0xE28AAdcd9883746c0e5068F58f9ea06027b214cb",
			blockCreated: 2411324
		} },
		l2OutputOracle: { [sourceId$56]: {
			address: "0x4a2635e9e4f6e45817b1D402ac4904c1d1752438",
			blockCreated: 2411324
		} },
		l1StandardBridge: { [sourceId$56]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/celoSepolia.js
var sourceId$55 = 11155111;
var celoSepolia = /*#__PURE__*/ defineChain({
	...chainConfig$2,
	id: 11142220,
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$55]: {
			address: "0x57c45d82d1a995f1e135b8d7edc0a6bb5211cfaa",
			blockCreated: 8825790
		} },
		l1StandardBridge: { [sourceId$55]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/chang.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/chiliz.js
var chiliz = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.chiliz.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/chips.js
var chips = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://node.chips.ooo/wasp/api/v1/chains/iota1pp3d3mnap3ufmgqnjsnw344sqmf5svjh26y2khnmc89sv6788y3r207a8fn/evm"] } }
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/citrea.js
var citrea = /*#__PURE__*/ defineChain({
	id: 4114,
	name: "Citrea Mainnet",
	nativeCurrency: {
		name: "Citrea Bitcoin",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/citreaTestnet.js
var citreaTestnet = /*#__PURE__*/ defineChain({
	id: 5115,
	name: "Citrea Testnet",
	nativeCurrency: {
		name: "cBTC",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/classic.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/codex.js
var sourceId$54 = 1;
var codex = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	id: 81224,
	name: "Codex",
	nativeCurrency: {
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$54]: { address: "0x6A3855dc26e2beA8Ac73f82Cda79f3808B6C6F6C" } },
		portal: { [sourceId$54]: { address: "0x52759C07A759c81BAab28AE1BE5A19e6450959bD" } },
		l1StandardBridge: { [sourceId$54]: { address: "0xa6b1A05a592719B0C8a70c69eac114C48410aDE4" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" }
	},
	sourceId: sourceId$54
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/codexTestnet.js
var sourceId$53 = 11155111;
var codexTestnet = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	id: 812242,
	name: "Codex Testnet",
	nativeCurrency: {
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$53]: { address: "0x390e24E8324E56f13A8d48eB938b6f9De24CD205" } },
		portal: { [sourceId$53]: { address: "0x037F161D12c829A9ca4742eEd9371830CA54fcB2" } },
		l1StandardBridge: { [sourceId$53]: { address: "0xCf4df2bDB14C8FDB25FdacCEC10Ce5C4bAEDB3De" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" }
	},
	sourceId: sourceId$53,
	testnet: true
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/coinbit.js
var coinbit = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://coinbit-rpc-mainnet.chain.sbcrypto.app"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/coinex.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/confluxESpace.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/confluxESpaceTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/coreDao.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/coreTestnet1.js
var coreTestnet1 = /*#__PURE__*/ defineChain({
	id: 1115,
	name: "Core Testnet",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/coreTestnet2.js
var coreTestnet2 = /*#__PURE__*/ defineChain({
	id: 1114,
	name: "Core Testnet2",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/cpchain.js
var cpchain = /*#__PURE__*/ defineChain({
	id: 86608,
	name: "CpChain",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://rpc.cpchain.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/crab.js
var crab = /*#__PURE__*/ defineChain({
	id: 44,
	name: "Crab Network",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/creatorTestnet.js
var creatorTestnet = /*#__PURE__*/ defineChain({
	id: 66665,
	name: "Creator",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/creditCoin3Devnet.js
var creditCoin3Devnet = /*#__PURE__*/ defineChain({
	id: 102032,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/creditCoin3Mainnet.js
var creditCoin3Mainnet = /*#__PURE__*/ defineChain({
	id: 102030,
	name: "Creditcoin",
	nativeCurrency: {
		name: "Creditcoin",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/creditCoin3Testnet.js
var creditCoin3Testnet = /*#__PURE__*/ defineChain({
	id: 102031,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/cronos.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/cronosTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/cronoszkEVM.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/cronoszkEVMTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/crossbell.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/crossfi.js
var crossfi = /*#__PURE__*/ defineChain({
	id: 4158,
	...
	rpcUrls: { default: { http: ["https://rpc.mainnet.ms"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/curtis.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/cyber.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/cyberTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dailyNetwork.js
var dailyNetwork = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.mainnet.dailycrypto.net"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dailyNetworkTestnet.js
var dailyNetworkTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.testnet.dailycrypto.net"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/darwinia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/datahavenTestnet.js
var datahavenTestnet = /*#__PURE__*/ defineChain({
	id: 55931,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dbkchain.js
var dbkchain = /*#__PURE__*/ defineChain({
	id: 20240603,
	name: "DBK chain",
	nativeCurrency: {
		name: "Ether",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dchain.js
var dchain = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://dchain-2716446429837000-1.jsonrpc.sagarpc.io"] } },
	blockExplorers: { default: {
		name: "Dchain Explorer",
		url: "https://dchain-2716446429837000-1.sagaexplorer.io",
		apiUrl: "https://api-dchain-2716446429837000-1.sagaexplorer.io/api"
	} },
	contracts: { ...chainConfig$3.contracts }
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dchainTestnet.js
var dchainTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://dchaintestnet-2713017997578000-1.jsonrpc.testnet.sagarpc.io"] } },
	blockExplorers: { default: {
		name: "Dchain Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/defichainEvm.js
var defichainEvm = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://eth.mainnet.ocean.jellyfishsdk.com"] } },
	blockExplorers: { default: {
		name: "DeFiScan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/defichainEvmTestnet.js
var defichainEvmTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://eth.testnet.ocean.jellyfishsdk.com"] } },
	blockExplorers: { default: {
		name: "DeFiScan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/degen.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dfk.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/diode.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/disChain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dodochainTestnet.js
var dodochainTestnet = /*#__PURE__*/ defineChain({
	id: 53457,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dogechain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/domaTestnet.js
var domaTestnet = /*#__PURE__*/ defineChain({
	id: 97476,
	name: "Doma Testnet",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/donatuz.js
var donatuz = /*#__PURE__*/ defineChain({
	id: 42026,
	name: "Donatuz",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dosChain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dosChainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dreyerxMainnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dreyerxTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dustboyIoT.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/dymension.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eden.js
var eden = /*#__PURE__*/ defineChain({
	id: 714,
	name: "Eden",
	nativeCurrency: {
		name: "TIA",
	...
	rpcUrls: { default: { http: ["https://rpc.eden.gateway.fm"] } },
	contracts: { multicall3: {
		address: "0xca11bde05977b3631167028862be2a173976ca11",
		blockCreated: 0
	} },
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/edexa.js
var edexa = /*#__PURE__*/ defineChain({
	id: 5424,
	name: "edeXa",
	nativeCurrency: {
		name: "edeXa",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/edexaTestnet.js
var edexaTestnet = /*#__PURE__*/ defineChain({
	id: 1995,
	name: "edeXa Testnet",
	nativeCurrency: {
		name: "edeXa",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/edgeless.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/edgelessTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/edgeware.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/edgewareTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eduChain.js
var eduChain = /*#__PURE__*/ defineChain({
	id: 41923,
	name: "EDU Chain",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://rpc.edu-chain.raas.gelato.cloud"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eduChainTestnet.js
var eduChainTestnet = /*#__PURE__*/ defineChain({
	id: 656476,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/elastos.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/elastosTestnet.js
var elastosTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://api-testnet.elastos.io/eth"] } },
	blockExplorers: { default: {
		name: "Elastos Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/electroneum.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/electroneumTestnet.js
var electroneumTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://testnet-rpc.electroneum.com"] } },
	blockExplorers: { default: {
		name: "Electroneum Block Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/elysiumTestnet.js
var elysiumTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://elysium-test-rpc.vulcanforged.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/energy.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eni.js
var eni = /*#__PURE__*/ defineChain({
	id: 173,
	name: "ENI Mainnet",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://rpc.eniac.network"] } },
	blockExplorers: { default: {
		name: "ENI Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eniTestnet.js
var eniTestnet = /*#__PURE__*/ defineChain({
	id: 6912115,
	name: "ENI Testnet",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://rpc-testnet.eniac.network"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/enuls.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eon.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eos.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eosTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/eteria.js
var eteria = /*#__PURE__*/ defineChain({
	id: 140,
	name: "Eteria",
	nativeCurrency: {
		name: "Eteria",
	...
	rpcUrls: { default: { http: ["https://mainnet.eteria.io/v1"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/etherlink.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/etherlinkShadownetTestnet.js
var etherlinkShadownetTestnet = /*#__PURE__*/ defineChain({
	id: 127823,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/etherlinkTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ethernity.js
var ethernity = /*#__PURE__*/ defineChain({
	id: 183,
	name: "Ethernity",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/etp.js
var etp = /*#__PURE__*/ defineChain({
	id: 20256789,
	name: "ETP Mainnet",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/evmos.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/evmosTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/excelonMainnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/expanse.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/exSat.js
var exsat = /*#__PURE__*/ defineChain({
	id: 7200,
	name: "exSat Network",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/exSatTestnet.js
var exsatTestnet = /*#__PURE__*/ defineChain({
	id: 839999,
	name: "exSat Testnet",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fantom.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fantomSonicTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fantomTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fibo.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/filecoin.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/filecoinCalibration.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/filecoinHyperspace.js
var filecoinHyperspace = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://api.hyperspace.node.glif.io/rpc/v1"] } },
	blockExplorers: { default: {
		name: "Filfox",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/flame.js
var flame = /*#__PURE__*/ defineChain({
	id: 253368190,
	name: "Flame",
	network: "flame",
	nativeCurrency: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/flare.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/flareTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/flowMainnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/flowPreviewnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/flowTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fluence.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fluenceStage.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fluenceTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fluent.js
var fluent = /*#__PURE__*/ defineChain({
	id: 25363,
	name: "Fluent",
	nativeCurrency: {
		name: "Ether",
	...
	rpcUrls: { default: { http: ["https://rpc.fluent.xyz"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fluentDevnet.js
var fluentDevnet = /*#__PURE__*/ defineChain({
	id: 20993,
	name: "Fluent Devnet",
	nativeCurrency: {
		name: "Ether",
	...
	rpcUrls: { default: { http: ["https://rpc.devnet.fluent.xyz"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fluentTestnet.js
var fluentTestnet = /*#__PURE__*/ defineChain({
	id: 20994,
	name: "Fluent Testnet",
	nativeCurrency: {
		name: "Ether",
	...
	rpcUrls: { default: { http: ["https://rpc.testnet.fluent.xyz"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/form.js
var sourceId$50 = 1;
var form = /*#__PURE__*/ defineChain({
	id: 478,
	name: "Form Network",
	nativeCurrency: {
		decimals: 18,
	...
	contracts: {
		...chainConfig$3.contracts,
		addressManager: { [sourceId$50]: { address: "0x15c249E46A2F924C2dB3A1560CF86729bAD1f07B" } },
		l1CrossDomainMessenger: { [sourceId$50]: { address: "0xF333158DCCad1dF6C3F0a3aEe8BC31fA94d9eD5c" } },
		l2OutputOracle: { [sourceId$50]: { address: "0x4ccAAF69F41c5810cA875183648B577CaCf1F67E" } },
		portal: { [sourceId$50]: { address: "0x4E259Ee5F4136408908160dD32295A5031Fa426F" } },
		l1StandardBridge: { [sourceId$50]: { address: "0xdc20aA63D3DE59574E065957190D8f24e0F7B8Ba" } },
		multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" }
	},
	sourceId: sourceId$50
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/forma.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/formTestnet.js
var sourceId$49 = 11155111;
var formTestnet = /*#__PURE__*/ defineChain({
	id: 132902,
	name: "Form Testnet",
	nativeCurrency: {
		decimals: 18,
	...
	contracts: {
		...chainConfig$3.contracts,
		addressManager: { [sourceId$49]: { address: "0xd5C38fa934f7fd7477D4800F4f38a1c5BFdF1373" } },
		l1CrossDomainMessenger: { [sourceId$49]: { address: "0x37A68565c4BE9700b3E3Ec60cC4416cAC3052FAa" } },
		l2OutputOracle: { [sourceId$49]: { address: "0x9eA2239E65a59EC9C7F1ED4C116dD58Da71Fc1e2" } },
		portal: { [sourceId$49]: { address: "0x60377e3cE15dF4CCA24c4beF076b60314240b032" } },
		l1StandardBridge: { [sourceId$49]: { address: "0xD4531f633942b2725896F47cD2aFd260b44Ab1F7" } },
		multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" }
	},
	testnet: true,
	sourceId: sourceId$49
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/forta.js
var forta = /*#__PURE__*/ defineChain({
	id: 80931,
	name: "Forta Chain",
	nativeCurrency: {
		symbol: "FORT",
	...
	rpcUrls: { default: { http: ["https://rpc-forta-chain-8gj1qndmfc.t.conduit.xyz"] } },
	blockExplorers: { default: {
		name: "Forta Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/foundry.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fraxtal.js
var sourceId$48 = 1;
var fraxtal = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$48]: { address: "0x66CC916Ed5C6C2FA97014f7D1cD141528Ae171e4" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$48]: {
			address: "0x36cb65c1967A0Fb0EEE11569C51C2f2aA1Ca6f6D",
			blockCreated: 19135323
		} },
		l1StandardBridge: { [sourceId$48]: {
			address: "0x34C0bD5877A5Ee7099D0f5688D65F4bB9158BDE2",
			blockCreated: 19135323
		} }
	},
	sourceId: sourceId$48
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fraxtalTestnet.js
var sourceId$47 = 17e3;
var fraxtalTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$47]: { address: "0x715EA64DA13F4d0831ece4Ad3E8c1aa013167F32" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$47]: {
			address: "0xB9c64BfA498d5b9a8398Ed6f46eb76d90dE5505d",
			blockCreated: 318416
		} },
		l1StandardBridge: { [sourceId$47]: {
			address: "0x0BaafC217162f64930909aD9f2B27125121d6332",
			blockCreated: 318416
		} }
	},
	sourceId: sourceId$47,
	testnet: true
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/funkiMainnet.js
var sourceId$46 = 1;
var funkiMainnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc-mainnet.funkichain.com"] } },
	blockExplorers: { default: {
		name: "Funki Mainnet Explorer",
		url: "https://funkiscan.io"
	} },
	contracts: { ...chainConfig$3.contracts },
	sourceId: sourceId$46
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/funkiSepolia.js
var sourceId$45 = 11155111;
var funkiSepolia = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	id: 3397901,
	...
	sourceId: sourceId$45
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fuse.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fuseSparknet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fusion.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/fusionTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/garnet.js
var sourceId$44 = 17e3;
var garnet = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	name: "Garnet Testnet",
	testnet: true,
	id: 17069,
	sourceId: sourceId$44,
	nativeCurrency: {
		name: "Ether",
		symbol: "ETH",
		decimals: 18
	...
	contracts: {
		...
		l2OutputOracle: { [sourceId$44]: {
			address: "0xCb8E7AC561b8EF04F2a15865e9fbc0766FEF569B",
			blockCreated: 1274684
		} },
		l1StandardBridge: { [sourceId$44]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/gatechain.js
var gatechain = /*#__PURE__*/ defineChain({
	id: 86,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/geist.js
var geist = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://geist-mainnet.g.alchemy.com/public"] } },
	blockExplorers: { default: {
		name: "Blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/genesys.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/gensyn.js
var gensyn = /*#__PURE__*/ defineChain({
	id: 685689,
	name: "Gensyn Mainnet",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://gensyn-mainnet.g.alchemy.com/public"] } },
	blockExplorers: { default: {
		name: "Blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/giwaSepolia.js
var sourceId$43 = 11155111;
var giwaSepolia = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	id: 91342,
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$43]: { address: "0x37347caB2afaa49B776372279143D71ad1f354F6" } },
		portal: { [sourceId$43]: { address: "0x956962C34687A954e611A83619ABaA37Ce6bC78A" } },
		l1StandardBridge: { [sourceId$43]: { address: "0x77b2ffc0F57598cAe1DB76cb398059cF5d10A7E7" } }
	},
	testnet: true,
...
var giwaSepoliaPreconf = defineChain({
	...giwaSepolia,
	experimental_preconfirmationTime: 200,
	rpcUrls: { default: { http: ["https://sepolia-rpc-flashblocks.giwa.io"] } }
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/glideL1Protocol.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/glideL2Protocol.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/gnosisChiado.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/goat.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/gobi.js
var gobi = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://gobi-testnet.horizenlabs.io/ethv1"] } },
	blockExplorers: { default: {
		name: "Gobi Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/goChain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/godwoken.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/goerli.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/graphite.js
var graphite = /*#__PURE__*/ defineChain({
	id: 440017,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/graphiteTestnet.js
var graphiteTestnet = /*#__PURE__*/ defineChain({
	id: 54170,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/gravity.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/gunz.js
var gunz = /*#__PURE__*/ defineChain({
	id: 43419,
	name: "Gunz Mainnet",
	nativeCurrency: {
		name: "GUN",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/guruNetwork.js
var guruNetwork = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc-main.gurunetwork.ai", "https://rpc.gurunetwork.ai/archive/260"] } },
	blockExplorers: { default: {
		name: "Guruscan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/guruTestnet.js
var guruTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc-test.gurunetwork.ai", "https://rpc.gurunetwork.ai/archive/261"] } },
	blockExplorers: { default: {
		name: "Guruscan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ham.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/happychainTestnet.js
var happychainTestnet = /*#__PURE__*/ defineChain({
	id: 216,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/haqqMainnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/haqqTestedge2.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hardhat.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/harmonyOne.js
var harmonyOne = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://1666600000.rpc.thirdweb.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hashKeyChain.js
var hashkey = /*#__PURE__*/ defineChain({
	id: 177,
	name: "HashKey Chain",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hashkeyChainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/haustTestnet.js
var haustTestnet = /*#__PURE__*/ defineChain({
	id: 1523903251,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hedera.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hederaPreviewnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hederaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hela.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/heliosTestnet.js
var heliosTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://testnet1.helioschainlabs.org"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hemi.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hemiSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/henesys.js
var henesys = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://henesys-rpc.msu.io"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/holesky.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/horizenTestnet.js
var horizenTestnet = /*#__PURE__*/ defineChain({
	id: 2651420,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hpb.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hpp.js
var hpp = /*#__PURE__*/ defineChain({
	id: 190415,
	name: "HPP Mainnet",
	nativeCurrency: {
		name: "Ether",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hppSepolia.js
var hppSepolia = /*#__PURE__*/ defineChain({
	id: 181228,
	name: "HPP Sepolia",
	nativeCurrency: {
		name: "Ether",
...
var huddle01Mainnet = /*#__PURE__*/ defineChain({
	id: 12323,
...
var huddle01Testnet = /*#__PURE__*/ defineChain({
	id: 2524852,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/humanity.js
var humanity = /*#__PURE__*/ defineChain({
	id: 6985385,
	name: "Humanity",
	nativeCurrency: {
		name: "H",
	...
	rpcUrls: { default: { http: ["https://humanity-mainnet.g.alchemy.com/public"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/humanityTestnet.js
var humanityTestnet = /*#__PURE__*/ defineChain({
	id: 7080969,
	...
	rpcUrls: { default: { http: ["https://rpc.testnet.humanity.org"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/humanode.js
var humanode = /*#__PURE__*/ defineChain({
	id: 5234,
	name: "Humanode",
	nativeCurrency: {
		name: "HMND",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/humanodeTestnet5.js
var humanodeTestnet5 = /*#__PURE__*/ defineChain({
	id: 14853,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hychain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hychainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hyperEvm.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/hyperliquidEvmTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/icbNetwork.js
var icbNetwork = /*#__PURE__*/ defineChain({
	id: 73115,
	name: "ICB Network",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://rpc1-mainnet.icbnetwork.info"] } },
	blockExplorers: { default: {
		name: "ICB Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/idchain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/igra.js
var igra = /*#__PURE__*/ defineChain({
	id: 38833,
	name: "Igra Network",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/immutableZkEvm.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/immutableZkEvmTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/inEVM.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/initVerse.js
var initVerse = /*#__PURE__*/ defineChain({
	id: 7233,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/initVerseGenesis.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/injective.js
var injective = /*#__PURE__*/ defineChain({
	id: 1776,
	name: "Injective",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/injectiveTestnet.js
var injectiveTestnet = /*#__PURE__*/ defineChain({
	id: 1439,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ink.js
var sourceId$40 = 1;
var ink = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$40]: { address: "0x10d7b35078d3baabb96dd45a9143b94be65b12cd" } },
		portal: { [sourceId$40]: { address: "0x5d66c1782664115999c47c9fa5cd031f495d3e4f" } },
		l1StandardBridge: { [sourceId$40]: { address: "0x88ff1e5b602916615391f55854588efcbb7663f0" } }
	},
	testnet: false,
	sourceId: sourceId$40
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/inkSepolia.js
var sourceId$39 = 11155111;
var inkSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$39]: { address: "0x860e626c700af381133d9f4af31412a2d1db3d5d" } },
		portal: { [sourceId$39]: { address: "0x5c1d29c6c9c8b0800692acc95d700bcb4966a1d7" } },
		l1StandardBridge: { [sourceId$39]: { address: "0x33f60714bbd74d62b66d79213c348614de51901c" } }
	},
	testnet: true,
	sourceId: sourceId$39
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/iota.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/iotaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/iotex.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/iotexTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/iSunCoin.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/jasmyChain.js
var jasmyChain = /*#__PURE__*/ defineChain({
	id: 680,
	name: "Jasmy Chain",
	network: "jasmyChain",
	nativeCurrency: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/jasmyChainTestnet.js
var jasmyChainTestnet = /*#__PURE__*/ defineChain({
	id: 681,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/jbc.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/jbcTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/jocMainnet.js
var jocMainnet = /*#__PURE__*/ defineChain({
	id: 81,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/jocTestnet.js
var jocTestnet = /*#__PURE__*/ defineChain({
	id: 10081,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/jovay.js
var jovay = /*#__PURE__*/ defineChain({
	id: 5734951,
	name: "Jovay Mainnet",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/jovaySepolia.js
var jovaySepolia = /*#__PURE__*/ defineChain({
	id: 2019775,
	...
	rpcUrls: { default: { http: ["https://api.zan.top/public/jovay-testnet"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneo.js
var juneo = /*#__PURE__*/ defineChain({
	id: 45003,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/JUNE/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoBCH1Chain.js
var juneoBCH1Chain = /*#__PURE__*/ defineChain({
	id: 45013,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/BCH1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoDAI1Chain.js
var juneoDAI1Chain = /*#__PURE__*/ defineChain({
	id: 45004,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/DAI1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoDOGE1Chain.js
var juneoDOGE1Chain = /*#__PURE__*/ defineChain({
	id: 45010,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/DOGE1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoEUR1Chain.js
var juneoEUR1Chain = /*#__PURE__*/ defineChain({
	id: 45011,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/EUR1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoGLD1Chain.js
var juneoGLD1Chain = /*#__PURE__*/ defineChain({
	id: 45008,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/GLD1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoLINK1Chain.js
var juneoLINK1Chain = /*#__PURE__*/ defineChain({
	id: 45014,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/LINK1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoLTC1Chain.js
var juneoLTC1Chain = /*#__PURE__*/ defineChain({
	id: 45009,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/LTC1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneomBTC1Chain.js
var juneomBTC1Chain = /*#__PURE__*/ defineChain({
	id: 45007,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/mBTC1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoSGD1Chain.js
var juneoSGD1Chain = /*#__PURE__*/ defineChain({
	id: 45012,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/SGD1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoSocotraTestnet.js
var juneoSocotraTestnet = /*#__PURE__*/ defineChain({
	id: 101003,
	...
	rpcUrls: { default: { http: ["https://rpc.socotra-testnet.network/ext/bc/JUNE/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoUSD1Chain.js
var juneoUSD1Chain = /*#__PURE__*/ defineChain({
	id: 45006,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/USD1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/juneoUSDT1Chain.js
var juneoUSDT1Chain = /*#__PURE__*/ defineChain({
	id: 45005,
	...
	rpcUrls: { default: { http: ["https://rpc.juneo-mainnet.network/ext/bc/USDT1/rpc"] } },
	blockExplorers: { default: {
		name: "Juneo Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kaia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kairos.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kakarotSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kakarotStarknetSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kardiaChain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/karura.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kava.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kavaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kcc.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kii.js
var kii = /*#__PURE__*/ defineChain({
	id: 1783,
	name: "KiiChain",
	network: "kii-chain",
	nativeCurrency: {
	...
	rpcUrls: { default: { http: ["https://json-rpc.kiivalidator.com"] } },
	blockExplorers: { default: {
		name: "KiiExplorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kiiTestnet.js
var kiiTestnetOro = /*#__PURE__*/ defineChain({
	id: 1336,
	...
	rpcUrls: { default: { http: ["https://json-rpc.uno.sentry.testnet.v3.kiivalidator.com"] } },
	blockExplorers: { default: {
		name: "KiiExplorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kinto.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/klaytn.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/klaytnBaobab.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/koi.js
var koi = /*#__PURE__*/ defineChain({
	id: 701,
	name: "Koi Network",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kroma.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/kromaSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/krown.js
var krown = /*#__PURE__*/ defineChain({
	id: 1983,
	name: "Krown",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://mainnet.krown.network"] } },
	blockExplorers: { default: {
		name: "Krown Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/l3x.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/l3xTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lavita.js
var lavita = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://tsub360890-eth-rpc.thetatoken.org/rpc"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lens.js
var lens = /*#__PURE__*/ defineChain({
	id: 232,
	name: "Lens",
	nativeCurrency: {
		name: "GHO",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lensTestnet.js
var lensTestnet = /*#__PURE__*/ defineChain({
	id: 37111,
	name: "Lens Testnet",
	nativeCurrency: {
		name: "GRASS",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lestnet.js
var lestnet = /*#__PURE__*/ defineChain({
	id: 21363,
	name: "Lestnet",
	nativeCurrency: {
		name: "Lestnet Ether",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lightlinkPegasus.js
var lightlinkPegasus = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://replicator.pegasus.lightlink.io/rpc/v1"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lightlinkPhoenix.js
...
//#endregion
//#region node_modules/viem/_esm/linea/actions/estimateGas.js
/**
...
async function estimateGas(client, args) {
	...
	try {
		...
		const block = (typeof blockNumber === "bigint" ? numberToHex$1(blockNumber) : void 0) || blockTag;
		assertRequest(args);
		const chainFormat = client.chain?.formatters?.transactionRequest?.format;
		const request = (chainFormat || formatTransactionRequest$1)({
...
//#endregion
//#region node_modules/viem/_esm/linea/chainConfig.js
var chainConfig$1 = { fees: {
	estimateFeesPerGas,
...
async function estimateFeesPerGas({ client, multiply, request, type }) {
	try {
		...
		const maxFeePerGas = multiply(BigInt(response.baseFeePerGas)) + maxPriorityFeePerGas;
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/linea.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lineaGoerli.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lineaSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lineaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lisk.js
var sourceId$38 = 1;
var lisk = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$38]: { address: "0x0CF7D3706a27CCE2017aEB11E8a9c8b5388c282C" } },
		multicall3: { address: "0xA9d71E1dd7ca26F26e656E66d6AA81ed7f745bf0" },
		l2OutputOracle: { [sourceId$38]: { address: "0x113cB99283AF242Da0A0C54347667edF531Aa7d6" } },
		portal: { [sourceId$38]: { address: "0x26dB93F8b8b4f7016240af62F7730979d353f9A7" } },
		l1StandardBridge: { [sourceId$38]: { address: "0x2658723Bf70c7667De6B25F99fcce13A16D25d08" } }
	},
	sourceId: sourceId$38
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/liskSepolia.js
var sourceId$37 = 11155111;
var liskSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$37]: { address: "0xA0E35F56C318DE1bD5D9ca6A94Fe7e37C5663348" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$37]: { address: "0xe3d90F21490686Ec7eF37BE788E02dfC12787264" } },
		l1StandardBridge: { [sourceId$37]: { address: "0x1Fb30e446eA791cd1f011675E5F3f5311b70faF5" } }
	},
	testnet: true,
	sourceId: sourceId$37
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/loadAlphanet.js
var loadAlphanet = /*#__PURE__*/ defineChain({
	id: 9496,
	name: "Load Alphanet",
	nativeCurrency: {
		name: "Testnet LOAD",
	...
	rpcUrls: { default: { http: ["https://alphanet.load.network"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/localhost.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/loop.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lukso.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/luksoTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lumiaMainnet.js
var lumiaMainnet = /*#__PURE__*/ defineChain({
	id: 994873017,
	name: "Lumia Mainnet",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lumiaTestnet.js
var lumiaTestnet = /*#__PURE__*/ defineChain({
	id: 1952959480,
	name: "Lumia Testnet",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lumoz.js
var lumoz = /*#__PURE__*/ defineChain({
	id: 96370,
	name: "Lumoz",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lumozTestnet.js
var lumozTestnet = /*#__PURE__*/ defineChain({
	id: 105363,
	name: "Lumoz Testnet",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/luxeports.js
var luxeports = /*#__PURE__*/ defineChain({
	id: 1122,
	name: "LuxePorts",
	network: "luxeports",
	nativeCurrency: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lycan.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/lyra.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mandala.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/manta.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mantaSepoliaTestnet.js
var mantaSepoliaTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://pacific-rpc.sepolia-testnet.manta.network/http"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mantaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mantle.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mantleSepoliaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mantleTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mantraDuKongEVMTestnet.js
var mantraDuKongEVMTestnet = /*#__PURE__*/ defineChain({
	id: 5887,
	...
	rpcUrls: { default: { http: ["https://evm.dukong.mantrachain.io"] } },
	blockExplorers: { default: {
		name: "MANTRAScan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mantraEVM.js
var mantraEVM = /*#__PURE__*/ defineChain({
	id: 5888,
	name: "MANTRA EVM",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mapProtocol.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/matchain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/matchainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mchVerse.js
var mchVerse = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.oasys.mycryptoheroes.net"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/megaeth.js
var sourceId$36 = 1;
var megaeth = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$36]: { address: "0x8546840adF796875cD9AAcc5B3B048f6B2c9D563" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
			blockCreated: 0
		},
		...
		l1StandardBridge: { [sourceId$36]: {
			address: "0x0CA3A2FBC3D770b578223FBB6b062fa875a2eE75",
			blockCreated: 21644285
		} }
	},
	sourceId: sourceId$36
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/megaethTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mekong.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/meld.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/memecore.js
var memecore = /*#__PURE__*/ defineChain({
	id: 4352,
	name: "MemeCore",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/memecoreFormicariumTestnet.js
var formicarium = /*#__PURE__*/ defineChain({
	id: 43521,
	name: "Formicarium",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/merlin.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/merlinErigonTestnet.js
var merlinErigonTestnet = /*#__PURE__*/ defineChain({
	id: 4203,
	...
	rpcUrls: { default: { http: ["https://testnet-erigon-rpc.merlinchain.io"] } },
	blockExplorers: { default: {
		name: "blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/metachain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/metachainIstanbul.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/metadium.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/metalL2.js
var sourceId$35 = 1;
var metalL2 = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$35]: { address: "0x3B1F7aDa0Fcc26B13515af752Dd07fB1CAc11426" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
			blockCreated: 0
		},
		portal: { [sourceId$35]: { address: "0x3F37aBdE2C6b5B2ed6F8045787Df1ED1E3753956" } },
		l1StandardBridge: { [sourceId$35]: { address: "0x6d0f65D59b55B0FEC5d2d15365154DcADC140BF3" } }
	},
	sourceId: sourceId$35
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/meter.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/meterTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/metis.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/metisGoerli.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/metisSepolia.js
var metisSepolia = /*#__PURE__*/ defineChain({
	id: 59902,
	name: "Metis Sepolia",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mev.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mevTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mezo.js
var mezo = /*#__PURE__*/ defineChain({
	id: 31612,
	name: "Mezo",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mezoTestnet.js
var mezoTestnet = /*#__PURE__*/ defineChain({
	id: 31611,
	name: "Mezo Testnet",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mint.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mintSepoliaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mitosisTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mizuhikiTestnetAwaji.js
var mizuhikiTestnetAwaji = /*#__PURE__*/ defineChain({
	id: 6497,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/mode.js
var sourceId$34 = 1;
var mode = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$34]: { address: "0x6f13EFadABD9269D6cEAd22b448d434A1f1B433E" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 2465882
		},
		l2OutputOracle: { [sourceId$34]: { address: "0x4317ba146D4933D889518a3e5E11Fe7a53199b04" } },
		portal: { [sourceId$34]: { address: "0x8B34b14c7c7123459Cf3076b8Cb929BE097d0C07" } },
		l1StandardBridge: { [sourceId$34]: { address: "0x735aDBbE72226BD52e818E7181953f42E3b0FF21" } }
	},
	sourceId: sourceId$34
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/modeTestnet.js
var sourceId$33 = 11155111;
var modeTestnet = /*#__PURE__*/ defineChain({
	...
	testnet: true,
	sourceId: sourceId$33
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/monad.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/monadTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/moonbaseAlpha.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/moonbeam.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/moonbeamDev.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/moonriver.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/morph.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/morphHolesky.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/morphSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/nahmii.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/nautilus.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/near.js
var near = /*#__PURE__*/ defineChain({
	id: 397,
	name: "NEAR Protocol",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/nearTestnet.js
var nearTestnet = /*#__PURE__*/ defineChain({
	id: 398,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/neonDevnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/neonMainnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/neoxMainnet.js
var neoxMainnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://mainnet-1.rpc.banelabs.org", "https://mainnet-2.rpc.banelabs.org"] } },
	blockExplorers: { default: {
		name: "Neo X - Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/neoxT4.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/newton.js
var newton = /*#__PURE__*/ defineChain({
	id: 1012,
	name: "Newton",
	nativeCurrency: {
		name: "Newton",
	...
	rpcUrls: { default: { http: ["https://global.rpc.mainnet.newtonproject.org"] } },
	blockExplorers: { default: {
		name: "NewFi explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/nexi.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/nexilix.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/nibiru.js
var nibiru = /*#__PURE__*/ defineChain({
	id: 6900,
	name: "Nibiru",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/nitrographTestnet.js
var nitrographTestnet = /*#__PURE__*/ defineChain({
	id: 200024,
	name: "Nitrograph Testnet",
	testnet: true,
	rpcUrls: { default: { http: ["https://rpc-testnet.nitrograph.foundation"] } },
	nativeCurrency: {
		name: "Nitro",
		symbol: "NOS",
		decimals: 18
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/nomina.js
var nomina = /*#__PURE__*/ defineChain({
	id: 166,
	name: "Nomina",
	nativeCurrency: {
		name: "Nomina",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/oasisTestnet.js
var oasisTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc1.oasis.bahamutchain.com"] } },
	blockExplorers: { default: {
		name: "Ftnscan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/oasys.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/odysseyTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/okc.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/omax.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/omni.js
var omni = /*#__PURE__*/ defineChain({
	id: 166,
	name: "Omni",
	nativeCurrency: {
		name: "Omni",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/omniOmega.js
var omniOmega = /*#__PURE__*/ defineChain({
	id: 164,
	name: "Omni Omega",
	nativeCurrency: {
		name: "Omni",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/oneWorld.js
var oneWorld = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://mainnet-rpc.oneworldchain.org"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/oortmainnetDev.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/opBNB.js
var sourceId$32 = 56;
var opBNB = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		l2OutputOracle: { [sourceId$32]: { address: "0x153CAB79f4767E2ff862C94aa49573294B13D169" } },
		portal: { [sourceId$32]: { address: "0x1876EA7702C0ad0C6A2ae6036DE7733edfBca519" } },
		l1StandardBridge: { [sourceId$32]: { address: "0xF05F0e4362859c3331Cb9395CBC201E3Fa6757Ea" } }
	},
	sourceId: sourceId$32
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/opBNBTestnet.js
var sourceId$31 = 97;
var opBNBTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		l2OutputOracle: { [sourceId$31]: { address: "0xFf2394Bb843012562f4349C6632a0EcB92fC8810" } },
		portal: { [sourceId$31]: { address: "0x4386C8ABf2009aC0c263462Da568DD9d46e52a31" } },
		l1StandardBridge: { [sourceId$31]: { address: "0x677311Fd2cCc511Bbc0f581E8d9a07B033D5E840" } }
	},
	testnet: true,
	sourceId: sourceId$31
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/openledger.js
var openledger = /*#__PURE__*/ defineChain({
	id: 1612,
	name: "OpenLedger",
	nativeCurrency: {
		name: "Open",
	...
	rpcUrls: { default: { http: ["https://rpc.openledger.xyz"] } },
	blockExplorers: { default: {
...
var optimism = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$30]: { address: "0xe5965Ab5962eDc7477C8520243A95517CD252fA9" } },
		l2OutputOracle: { [sourceId$30]: { address: "0xdfe97868233d1aa22e815a266982f2cf17685a27" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 4286263
		},
		portal: { [sourceId$30]: { address: "0xbEb5Fc579115071764c7423A4f12eDde41f106Ed" } },
		l1StandardBridge: { [sourceId$30]: { address: "0x99C9fc46f92E8a1c0deC1b1747d010903E884bE1" } }
	},
	sourceId: sourceId$30
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/optimismGoerli.js
var sourceId$29 = 5;
var optimismGoerli = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$29]: { address: "0xE6Dfba0953616Bacab0c9A8ecb3a9BBa77FC15c0" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 49461
		},
		portal: { [sourceId$29]: { address: "0x5b47E1A08Ea6d985D6649300584e6722Ec4B1383" } },
		l1StandardBridge: { [sourceId$29]: { address: "0x636Af16bf2f682dD3109e60102b8E1A089FedAa8" } }
	},
	testnet: true,
	sourceId: sourceId$29
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/optimismSepolia.js
var sourceId$28 = 11155111;
var optimismSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$28]: { address: "0x05F9613aDB30026FFd634f38e5C4dFd30a197Fa1" } },
		l2OutputOracle: { [sourceId$28]: { address: "0x90E9c4f8a994a250F6aEfd61CAFb4F2e895D458F" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 1620204
		},
		portal: { [sourceId$28]: { address: "0x16Fc5058F25648194471939df75CF27A2fdC48BC" } },
		l1StandardBridge: { [sourceId$28]: { address: "0xFBb0621E0B23b5478B630BD55a5f21f67730B0F1" } }
	},
	testnet: true,
	sourceId: sourceId$28
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/optopia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/optopiaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/orderly.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/orderlySepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/otimDevnet.js
var otimDevnet = /*#__PURE__*/ defineChain({
	...
	contracts: { batchInvoker: { address: "0x5FbDB2315678afecb367f032d93F642f64180aa3" } },
	testnet: true
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/palm.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/palmTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/paseoPassetHub.js
var paseoPassetHub = /*#__PURE__*/ defineChain({
	id: 420420422,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/peaq.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/pgn.js
var sourceId$27 = 1;
var pgn = /*#__PURE__*/ defineChain({
	...
	contracts: {
		l2OutputOracle: { [sourceId$27]: { address: "0x9E6204F750cD866b299594e2aC9eA824E2e5f95c" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
			blockCreated: 3380209
		},
		portal: { [sourceId$27]: { address: "0xb26Fd985c5959bBB382BAFdD0b879E149e48116c" } },
		l1StandardBridge: { [sourceId$27]: { address: "0xD0204B9527C1bA7bD765Fa5CCD9355d38338272b" } }
	},
	formatters: formatters$1,
	sourceId: sourceId$27
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/pgnTestnet.js
var sourceId$26 = 11155111;
var pgnTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		l2OutputOracle: { [sourceId$26]: { address: "0xD5bAc3152ffC25318F848B3DD5dA6C85171BaEEe" } },
		portal: { [sourceId$26]: { address: "0xF04BdD5353Bb0EFF6CA60CfcC78594278eBfE179" } },
		l1StandardBridge: { [sourceId$26]: { address: "0xFaE6abCAF30D23e233AC7faF747F2fC3a5a6Bfa3" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
	...
	formatters: formatters$1,
	sourceId: sourceId$26,
	testnet: true
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/phoenix.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/planq.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/plasma.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/plasmaDevnet.js
var plasmaDevnet = /*#__PURE__*/ defineChain({
	id: 9747,
	name: "Plasma Devnet",
	nativeCurrency: {
		name: "Devnet Plasma",
	...
	rpcUrls: { default: { http: ["https://devnet-rpc.plasma.to"] } },
	testnet: true,
	contracts: { multicall3: {
		address: "0xcA11bde05977b3631167028862bE2a173976CA11",
		blockCreated: 0
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/plasmaTestnet.js
var plasmaTestnet = /*#__PURE__*/ defineChain({
	id: 9746,
	name: "Plasma Testnet",
	nativeCurrency: {
		name: "Testnet Plasma",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/playfiAlbireo.js
var playfiAlbireo = /*#__PURE__*/ defineChain({
	...
	contracts: { multicall3: { address: "0xF9cda624FBC7e059355ce98a31693d299FACd963" } },
	testnet: true
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/plinga.js
...
var plumeSepolia = /*#__PURE__*/ defineChain({
	id: 98867,
	name: "Plume Testnet",
	nativeCurrency: {
		name: "Plume",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/polterTestnet.js
var polterTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://geist-polter.g.alchemy.com/public"] } },
	blockExplorers: { default: {
		name: "Blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/polygonMumbai.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/polygonZkEvm.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/polygonZkEvmCardona.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/polygonZkEvmTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/polynomial.js
var polynomial = /*#__PURE__*/ defineChain({
	id: 8008,
	name: "Polynomial",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/polynomialSepolia.js
var polynomialSepolia = /*#__PURE__*/ defineChain({
	id: 80008,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/potos.js
var potos = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.potos.hk"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/potosTestnet.js
var potosTestnet = /*#__PURE__*/ defineChain({
	id: 60600,
	name: "POTOS Testnet",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://rpc-testnet.potos.hk"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/premiumBlock.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/pulsechain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/pulsechainV4.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/pumpfiTestnet.js
var pumpfiTestnet = /*#__PURE__*/ defineChain({
	id: 490092,
	name: "Pumpfi Testnet",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/pyrope.js
var sourceId$20 = 11155111;
var pyrope = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	name: "Pyrope Testnet",
	testnet: true,
	id: 695569,
	...
	contracts: {
		...chainConfig$3.contracts,
		l1StandardBridge: { [sourceId$20]: { address: "0xC24932c31D9621aE9e792576152B7ef010cFC2F8" } }
	}
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ql1.js
var ql1 = /*#__PURE__*/ defineChain({
	...
	contracts: { multicall3: { address: "0x7A52370716ea730585884F5BDB0f6E60C39b8C64" } },
	testnet: false
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/qMainnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/qTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/quai.js
var quai = /*#__PURE__*/ defineChain({
	id: 9,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/quaiTestnet.js
var quaiTestnet = /*#__PURE__*/ defineChain({
	id: 15e3,
	...
	rpcUrls: { default: { http: ["https://orchard.rpc.quai.network/cyprus1"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/radius.js
var radius = /*#__PURE__*/ defineChain({
	id: 723487,
	name: "Radius Network",
	nativeCurrency: {
		name: "Radius USD",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/radiusTestnet.js
var radiusTestnet = /*#__PURE__*/ defineChain({
	id: 72344,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/reactiveTestnet.js
var reactiveTestnet = /*#__PURE__*/ defineChain({
	id: 5318007,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/real.js
var real = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.realforreal.gelato.digital"] } },
	blockExplorers: { default: {
		name: "re.al Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/redbellyMainnet.js
var redbellyMainnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://governors.mainnet.redbelly.network"] } },
	blockExplorers: { default: {
		name: "Routescan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/redbellyTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/reddio.js
var reddio = /*#__PURE__*/ defineChain({
	id: 50342,
	name: "Reddio",
	nativeCurrency: {
		name: "Reddio",
	...
	rpcUrls: { default: { http: ["https://mainnet.reddio.com/rpc"] } },
	blockExplorers: { default: {
		name: "Blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/reddioSepolia.js
var reddioSepolia = /*#__PURE__*/ defineChain({
	id: 50341,
	name: "Reddio Sepolia",
	nativeCurrency: {
		name: "Reddio",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/redstone.js
var sourceId$19 = 1;
var redstone = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	name: "Redstone",
	id: 690,
	sourceId: sourceId$19,
	nativeCurrency: {
		decimals: 18,
		name: "Ether",
		symbol: "ETH"
	...
	contracts: {
		...
		l2OutputOracle: { [sourceId$19]: {
			address: "0xa426A052f657AEEefc298b3B5c35a470e4739d69",
			blockCreated: 19578337
		} },
		l1StandardBridge: { [sourceId$19]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rei.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/reyaNetwork.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rise.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/riseTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rivalz.js
var rivalz = /*#__PURE__*/ defineChain({
	id: 753,
	name: "Rivalz",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rollux.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rolluxTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ronin.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/root.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rootPorcini.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rootstock.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rootstockTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rss3.js
var sourceId$18 = 1;
var rss3 = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$18]: { address: "0xE6f24d2C32B3109B18ed33cF08eFb490b1e09C10" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 14193
		},
		...
		l1StandardBridge: { [sourceId$18]: { address: "0x4cbab69108Aa72151EDa5A3c164eA86845f18438" } }
	},
	sourceId: sourceId$18
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/rss3Sepolia.js
var sourceId$17 = 11155111;
var rss3Sepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$17]: { address: "0xDb5c46C3Eaa6Ed6aE8b2379785DF7dd029C0dC81" } },
		multicall3: {
			address: "0xca11bde05977b3631167028862be2a173976ca11",
			blockCreated: 55697
		},
		...
		l1StandardBridge: { [sourceId$17]: { address: "0xdDD29bb63B0839FB1cE0eE439Ff027738595D07B" } }
	},
	testnet: true,
	sourceId: sourceId$17
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/saakuru.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/saga.js
var saga = /*#__PURE__*/ defineChain({
	id: 5464,
	name: "Saga",
	network: "saga",
	nativeCurrency: {
	...
	rpcUrls: { default: { http: ["https://sagaevm.jsonrpc.sagarpc.io"] } },
	blockExplorers: { default: {
		name: "Saga Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/saigon.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sanko.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sapphire.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sapphireTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/satoshivm.js
var satoshiVM = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://alpha-rpc-node-http.svmscan.io"] } },
	blockExplorers: { default: {
		name: "blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/satoshivmTestnet.js
var satoshiVMTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://test-rpc-node-http.svmscan.io"] } },
	blockExplorers: { default: {
		name: "blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/scroll.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/scrollSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sei.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/seismicDevnet.js
var seismicDevnet = /*#__PURE__*/ defineChain({
	id: 5124,
	name: "Seismic Devnet",
	nativeCurrency: {
		name: "Seismic Ether",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/seiTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sentrix.js
var sentrix = /*#__PURE__*/ defineChain({
	id: 7119,
	name: "Sentrix Chain",
	nativeCurrency: {
		name: "Sentrix",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sentrixTestnet.js
var sentrixTestnet = /*#__PURE__*/ defineChain({
	id: 7120,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shape.js
var sourceId$16 = 1;
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shapeSepolia.js
var sourceId$15 = 11155111;
var shapeSepolia = /*#__PURE__*/ defineChain({
	...
	testnet: true,
	sourceId: sourceId$15
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shardeum.js
var shardeum = /*#__PURE__*/ defineChain({
	id: 8118,
	name: "Shardeum",
	nativeCurrency: {
		name: "Shardeum",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shardeumSphinx.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shibarium.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shibariumTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shiden.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shimmer.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/shimmerTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sidra.js
var sidraChain = /*#__PURE__*/ defineChain({
	id: 97453,
	name: "Sidra Chain",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/silentdata.js
var silentData = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://mainnet.silentdata.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/silicon.js
var silicon = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.silicon.network", "https://silicon-mainnet.nodeinfra.com"] } },
	blockExplorers: { default: {
		name: "SiliconScope",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/siliconSepolia.js
var siliconSepolia = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc-sepolia.silicon.network", "https://silicon-testnet.nodeinfra.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sixProtocol.js
var sixProtocol = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://sixnet-rpc-evm.sixprotocol.net"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/brawl.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/calypso.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/calypsoTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/cryptoBlades.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/cryptoColosseum.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/europa.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/europaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/exorde.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/humanProtocol.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/nebula.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/nebulaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/razor.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/skaleBase.js
var skaleBase = /*#__PURE__*/ defineChain({
	id: 1187947933,
	name: "SKALE Base",
	nativeCurrency: {
		name: "Credits",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/skaleBaseSepoliaTestnet.js
var skaleBaseSepoliaTestnet = /*#__PURE__*/ defineChain({
	id: 324705682,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/titan.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/skale/titanTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sketchpad.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/snax.js
var sourceId$14 = 1;
var snax = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$14]: { address: "0x472562Fcf26D6b2793f8E0b0fB660ba0E5e08A46" } },
		l2OutputOracle: { [sourceId$14]: { address: "0x2172e492Fc807F5d5645D0E3543f139ECF539294" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$14]: { address: "0x79f446D024d74D0Bb6E699C131c703463c5D65E9" } },
		l1StandardBridge: { [sourceId$14]: { address: "0x6534Bdb6b5c060d3e6aa833433333135eFE8E0aA" } }
	},
	sourceId: sourceId$14
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/snaxTestnet.js
var sourceId$13 = 11155111;
var snaxTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$13]: { address: "0x206a75d89d45F146C54020F132FF93bEDD09f55E" } },
		l2OutputOracle: { [sourceId$13]: { address: "0x60e3A368a4cdCEf85ffB964e372726F56A46221e" } },
		multicall3: { address: "0xca11bde05977b3631167028862be2a173976ca11" },
		portal: { [sourceId$13]: { address: "0xb5afdd0E8dDF081Ef90e8A3e0c7b5798e66E954E" } },
		l1StandardBridge: { [sourceId$13]: { address: "0xbd37E1a59D4C00C9A46F75018dffd84061bC5f74" } }
	},
	testnet: true,
	sourceId: sourceId$13
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/somnia.js
var somnia = /*#__PURE__*/ defineChain({
	id: 5031,
	name: "Somnia",
	nativeCurrency: {
		name: "Somnia",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/somniaTestnet.js
var somniaTestnet = /*#__PURE__*/ defineChain({
	id: 50312,
	name: "Somnia Testnet",
	nativeCurrency: {
		name: "STT",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/soneium.js
var sourceId$12 = 1;
var soneium = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$12]: { address: "0x512a3d2c7a43bd9261d2b8e8c9c70d4bd4d503c0" } },
		l2OutputOracle: { [sourceId$12]: { address: "0x0000000000000000000000000000000000000000" } },
		portal: { [sourceId$12]: {
			address: "0x88e529a6ccd302c948689cd5156c83d4614fae92",
			blockCreated: 7061266
		} },
		l1StandardBridge: { [sourceId$12]: {
	...
	sourceId: sourceId$12
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/soneiumMinato.js
var sourceId$11 = 11155111;
var soneiumMinato = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$11]: { address: "0xB3Ad2c38E6e0640d7ce6aA952AB3A60E81bf7a01" } },
		l2OutputOracle: { [sourceId$11]: { address: "0x710e5286C746eC38beeB7538d0146f60D27be343" } },
		portal: { [sourceId$11]: {
			address: "0x65ea1489741A5D72fFdD8e6485B216bBdcC15Af3",
			blockCreated: 6466136
		} },
		l1StandardBridge: { [sourceId$11]: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/songbird.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/songbirdTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sonic.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sonicBlazeTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sonicTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sophon.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sophonTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sova.js
var sova = /*#__PURE__*/ defineChain({
	id: 100021,
	name: "Sova",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://rpc.sova.io"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/sovaSepolia.js
var sovaSepolia = /*#__PURE__*/ defineChain({
	id: 120893,
	...
	rpcUrls: { default: { http: ["https://rpc.testnet.sova.io"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/spicy.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/stable.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/stableTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/statusNetworkSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/step.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/story.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/storyAeneid.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/storyOdyssey.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/storyTestnet.js
/** @deprecated Use `storyAeneid` instead  */
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/stratis.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/subtensorEvm.js
var subtensorEvm = /*#__PURE__*/ defineChain({
	id: 964,
	name: "Subtensor EVM",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/superlumio.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/superposition.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/superseed.js
var sourceId$10 = 1;
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/superseedSepolia.js
var sourceId$9 = 11155111;
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/surgeTestnet.js
var surgeTestnet = /*#__PURE__*/ defineChain({
	id: 763375,
	name: "Surge Testnet",
	nativeCurrency: {
		name: "Ether",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/swan.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/swanProximaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/swanSaturnTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/swellchain.js
var swellchain = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	id: 1923,
	name: "Swellchain",
	nativeCurrency: {
	...
	rpcUrls: { default: { http: ["https://swell-mainnet.alt.technology"] } },
	blockExplorers: { default: {
		name: "Swell Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/swellchainTestnet.js
var swellchainTestnet = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	id: 1924,
	...
	rpcUrls: { default: { http: ["https://swell-testnet.alt.technology"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/swissdlt.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/syscoin.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/syscoinTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tac.js
var tac = /*#__PURE__*/ defineChain({
	id: 239,
	name: "TAC",
	nativeCurrency: {
		name: "TAC",
	...
	rpcUrls: { default: { http: ["https://rpc.ankr.com/tac"] } },
	blockExplorers: {
		default: {
			name: "Blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tacSPB.js
var tacSPB = /*#__PURE__*/ defineChain({
	id: 2391,
	...
	rpcUrls: { default: { http: ["https://spb.rpc.tac.build"] } },
	blockExplorers: { default: {
		name: "TAC",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/taiko.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/taikoHekla.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/taikoHoodi.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/taikoJolnir.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/taikoKatla.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/taikoTestnetSepolia.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/taraxa.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/taraxaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/teaSepolia.js
var teaSepolia = /*#__PURE__*/ defineChain({
	id: 10218,
	name: "Tea Sepolia",
	nativeCurrency: {
		name: "Sepolia Tea",
	...
	rpcUrls: { default: { http: ["https://tea-sepolia.g.alchemy.com/public"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/telcoinTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/telos.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/telosTestnet.js
...
//#endregion
//#region node_modules/@noble/curves/esm/nist.js
/**
...
//#endregion
//#region node_modules/@noble/curves/esm/p256.js
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
var secp256r1 = p256;
//#endregion
//#region node_modules/ox/_esm/core/P256.js
/**
...
function verify$3(options) {
	...
	return secp256r1.verify(signature, payload instanceof Uint8Array ? payload : fromHex(payload), toHex$1(publicKey).substring(2), {
		lowS: true,
		...hash ? { prehash: true } : {}
	});
}
...
function verify$2(options) {
	...
	if (rpId !== void 0) {
		if (!isEqual(authenticatorDataBytes.slice(0, 32), sha256$2(fromString(rpId), { as: "Bytes" }))) return false;
	}
	const flag = authenticatorDataBytes[32];
	if ((flag & 1) !== 1) return false;
	if (userVerificationRequired && (flag & 4) !== 4) return false;
	if ((flag & 8) !== 8 && (flag & 16) === 16) return false;
	const clientData = JSON.parse(clientDataJSON);
	if (clientData.type !== "webauthn.get") return false;
	if (!clientData.challenge || fromBytes(toBytes(clientData.challenge)) !== challenge) return false;
	if (origin !== void 0) {
		if (!(Array.isArray(origin) ? origin : [origin]).includes(clientData.origin)) return false;
	}
	return verify$3({
		hash: true,
		payload: concat(authenticatorDataBytes, sha256$2(fromString$1(clientDataJSON), { as: "Bytes" })),
		publicKey,
		signature
	});
}
...
//#endregion
//#region node_modules/ox/_esm/tempo/SignatureEnvelope.js
...
function extractPublicKey(options) {
	...
	switch (signature.type) {
		case "secp256k1": return recoverPublicKey({
			payload,
			signature: signature.signature
		});
		case "p256":
		case "webAuthn": return signature.publicKey;
		case "keychain": return extractPublicKey({
			payload,
			signature: signature.inner
		});
	}
...
function deserialize$1(value) {
	const serialized = value.endsWith("0x7777777777777777777777777777777777777777777777777777777777777777".slice(2)) ? slice(value, 0, -size(magicBytes)) : value;
	if (size(serialized) === 65) {
		const signature = fromHex$1(serialized);
		assert$1(signature);
		return {
			signature,
			type: "secp256k1"
	...
	if (typeId === serializedP256Type) {
		if (dataSize !== 129) throw new InvalidSerializedError$1({
	...
	if (typeId === serializedWebAuthnType) {
		if (dataSize < 128) throw new InvalidSerializedError$1({
		...
		for (let split = 37; split < webauthnDataSize; split++) {
			...
			if (potentialJson.startsWith("{") && potentialJson.endsWith("}")) try {
		...
		if (!authenticatorData || !clientDataJSON) throw new InvalidSerializedError$1({
	...
	if (typeId === serializedKeychainType || typeId === serializedKeychainV2Type) return {
		userAddress: slice(data, 0, 20),
		inner: deserialize$1(slice(data, 20)),
		type: "keychain",
...
*/
function from$3(value, options) {
	if (typeof value === "string") return deserialize$1(value);
	...
	return {
		...
		...type === "keychain" ? {
			...
			...!(typeof value === "object" && "keyId" in value && value.keyId) ? (() => {
				...
				if (inner.type === "p256" || inner.type === "webAuthn") return { keyId: fromPublicKey(inner.publicKey) };
				if (inner.type === "secp256k1" && options?.payload) return { keyId: fromPublicKey(recoverPublicKey({
...
function fromRpc$4(envelope) {
	if (envelope.type === "secp256k1") return {
		signature: fromRpc$5(envelope),
		type: "secp256k1"
	};
	if (envelope.type === "p256") return {
	...
	if (envelope.type === "keychain" || "userAddress" in envelope && "signature" in envelope) return {
		...
		inner: fromRpc$4(envelope.signature),
...
*/
function getType$1(envelope) {
	if (typeof envelope !== "object" || envelope === null) throw new CoercionError({ envelope });
...
function serialize$2(envelope, options = {}) {
	const type = getType$1(envelope);
	if (type === "secp256k1") return concat$1(toHex$2(envelope.signature), options.magic ? magicBytes : "0x");
	if (type === "p256") {
		const p256 = envelope;
		return concat$1(serializedP256Type, fromNumber(p256.signature.r, { size: 32 }), fromNumber(p256.signature.s, { size: 32 }), fromNumber(p256.publicKey.x, { size: 32 }), fromNumber(p256.publicKey.y, { size: 32 }), fromNumber(p256.prehash ? 1 : 0, { size: 1 }), options.magic ? magicBytes : "0x");
	}
	if (type === "webAuthn") {
		const webauthn = envelope;
		return concat$1(serializedWebAuthnType, concat$1(webauthn.metadata.authenticatorData, fromString(webauthn.metadata.clientDataJSON)), fromNumber(webauthn.signature.r, { size: 32 }), fromNumber(webauthn.signature.s, { size: 32 }), fromNumber(webauthn.publicKey.x, { size: 32 }), fromNumber(webauthn.publicKey.y, { size: 32 }), options.magic ? magicBytes : "0x");
	}
	if (type === "keychain") {
		const keychain = envelope;
		return concat$1(keychain.version === "v1" ? serializedKeychainType : serializedKeychainV2Type, keychain.userAddress, serialize$2(keychain.inner), options.magic ? magicBytes : "0x");
	}
	throw new CoercionError({ envelope });
}
/**
...
function toRpc$4(envelope) {
	const type = getType$1(envelope);
	if (type === "secp256k1") return {
		...toRpc$5(envelope.signature),
		type: "secp256k1"
	};
	if (type === "p256") {
		const p256 = envelope;
		return {
			...
			pubKeyX: fromNumber(p256.publicKey.x, { size: 32 }),
			pubKeyY: fromNumber(p256.publicKey.y, { size: 32 }),
			r: fromNumber(p256.signature.r, { size: 32 }),
			s: fromNumber(p256.signature.s, { size: 32 }),
			type: "p256"
		};
	}
	if (type === "webAuthn") {
		const webauthn = envelope;
		const webauthnData = concat$1(webauthn.metadata.authenticatorData, fromString(webauthn.metadata.clientDataJSON));
		return {
...
function verify(signature, parameters) {
	...
	const address = (() => {
		...
		if (parameters.publicKey) return fromPublicKey(parameters.publicKey);
	})();
	if (!address) return false;
	const envelope = from$3(signature);
	...
	if (envelope.type === "p256") {
		if (!isEqual$1(fromPublicKey(envelope.publicKey), address)) return false;
		return verify$3({
...
*/
var CoercionError = class extends BaseError$1 {
...
*/
var InvalidSerializedError$1 = class extends BaseError$1 {
	constructor({ reason, serialized }) {
		super(`Unable to deserialize signature envelope: ${reason}`, { metaMessages: [`Serialized: ${serialized}`] });
		Object.defineProperty(this, "name", {
			enumerable: true,
			configurable: true,
			writable: true,
...
*/
var VerificationError = class extends BaseError$1 {
	constructor() {
		super(...arguments);
		Object.defineProperty(this, "name", {
			enumerable: true,
...
//#endregion
//#region node_modules/ox/_esm/tempo/TempoAddress.js
/**
...
function parse(tempoAddress) {
	if (!tempoAddress.startsWith("tempox")) throw new InvalidPrefixError({ address: tempoAddress });
	const hex = tempoAddress.slice(6);
	assert$2(hex, { strict: true });
...
//#endregion
//#region node_modules/ox/_esm/tempo/AuthorizationTempo.js
/**
...
*/
function from$2(authorization, options = {}) {
	if (typeof authorization.chainId === "string") return fromRpc$3(authorization);
	const resolved = {
		...authorization,
...
function fromTuple$1(tuple) {
	...
	if (signatureSerialized) args.signature = deserialize$1(signatureSerialized);
	return from$2(args);
}
/**
...
function fromTupleList$1(tupleList) {
	const list = [];
	for (const tuple of tupleList) list.push(fromTuple$1(tuple));
	return list;
}
/**
...
function toTuple$1(authorization) {
	const { address, chainId, nonce } = authorization;
	const signature = authorization.signature ? serialize$2(authorization.signature) : void 0;
	return [
...
function toTupleList$1(list) {
	...
	const tupleList = [];
	for (const authorization of list) tupleList.push(toTuple$1(authorization));
	return tupleList;
}
//#endregion
//#region node_modules/ox/_esm/tempo/TokenId.js
...
function toAddress(tokenId) {
	...
	return concat$1(tip20Prefix, fromNumber(tokenId, { size: 18 }));
}
//#endregion
//#region node_modules/ox/_esm/tempo/KeyAuthorization.js
/**
...
function from$1(authorization, options = {}) {
	if ("keyId" in authorization) return fromRpc$2(authorization);
	const auth = authorization;
	if (auth.witness !== void 0) assertWitness(auth.witness);
	const resolved = {
		...auth,
		address: resolve(auth.address),
		...auth.limits ? { limits: auth.limits.map((l) => ({
			...l,
			token: resolve(l.token)
		})) } : {},
		...auth.scopes ? { scopes: auth.scopes.map((scope) => ({
			...scope,
			address: resolve(scope.address),
			selector: resolveSelector(scope.selector),
			...scope.recipients ? { recipients: scope.recipients.map((r) => resolve(r)) } : {}
		})) } : {}
	};
	if (options.signature) return {
		...resolved,
		signature: from$3(options.signature)
	};
	return resolved;
}
/**
...
function fromRpc$2(authorization) {
	...
	const signature = fromRpc$4(authorization.signature);
	if (witness !== void 0) assertWitness(witness);
	const scopes = allowedCalls ? allowedCalls.flatMap((callScope) => {
		if (!callScope.selectorRules || callScope.selectorRules.length === 0) return [{ address: callScope.target }];
...
function fromTuple(tuple) {
	...
	const keyType = (() => {
		switch (keyType_hex) {
			case "0x":
			case "0x00": return "secp256k1";
			case "0x01": return "p256";
			case "0x02": return "webAuthn";
			default: throw new Error(`Invalid key type: ${keyType_hex}`);
		}
	})();
	...
	const scopes = Array.isArray(rawScopes) ? rawScopes.flatMap((scopeTuple) => {
		...
		if (!Array.isArray(selectorRules) || selectorRules.length === 0) return [{ address }];
	...
	if (witness !== void 0) assertWitness(witness);
	const isAdmin = (() => {
		if (isAbsent(rawIsAdmin)) return void 0;
		if (rawIsAdmin !== "0x01") throw new InvalidAdminMarkerError(rawIsAdmin);
		return true;
	})();
	const account = isAbsent(rawAccount) ? void 0 : rawAccount;
	const adminPair = account !== void 0 && isAdmin ? {
		account,
		isAdmin: true
	} : {};
	const args = {
...
*/
function getSignPayload$1(authorization) {
...
function hash$1(authorization) {
	...
	return keccak256(fromHex$2(authorizationTuple));
}
/**
...
function toRpc$2(authorization) {
	...
	const allowedCalls = (() => {
		...
		for (const scope of scopes) {
			...
			if (scope.selector) grouped.get(key).push({
				selector: resolveSelector(scope.selector),
...
function toTuple(authorization) {
	...
	const type = (() => {
		switch (authorization.type) {
			case "secp256k1": return "0x";
			case "p256": return "0x01";
			case "webAuthn": return "0x02";
			default: throw new Error(`Invalid key type: ${authorization.type}`);
		}
	})();
	...
	const callsValue = (() => {
		...
		for (const scope of scopes) {
			const key = scope.address;
			if (!grouped.has(key)) grouped.set(key, []);
			if (scope.selector) grouped.get(key).push([resolveSelector(scope.selector), scope.recipients ?? []]);
		}
		return [...grouped.entries()].map(([address, selectorRules]) => [address, selectorRules.map(([selector, recipients]) => [selector, recipients])]);
	})();
	...
	let lastPresent = -1;
	for (let i = optionals.length - 1; i >= 0; i--) if (optionals[i].value !== void 0) {
		lastPresent = i;
		break;
	}
...
function normalizeSelector(selector) {
	...
	if (Array.isArray(selector)) return fromBytes(new Uint8Array(selector));
	return selector;
}
...
function assertWitness(witness) {
	if (size(witness) !== 32) throw new InvalidWitnessSizeError(witness);
}
...
//#endregion
//#region node_modules/ox/_esm/core/Transaction.js
...
function fromRpc$1(transaction, _options = {}) {
	...
	const signature = extract$1(transaction);
	const transaction_ = {
		...transaction,
		...signature
	};
	transaction_.blockNumber = transaction.blockNumber ? BigInt(transaction.blockNumber) : null;
	if ("blockTimestamp" in transaction) transaction_.blockTimestamp = transaction.blockTimestamp ? BigInt(transaction.blockTimestamp) : transaction.blockTimestamp === null ? null : void 0;
	...
	if (transaction.authorizationList) transaction_.authorizationList = fromRpcList$1(transaction.authorizationList);
	...
	if (transaction.type) transaction_.type = fromRpcType$1[transaction.type] ?? transaction.type;
	if (signature) transaction_.v = yParityToV(signature.yParity);
	return transaction_;
}
//#endregion
//#region node_modules/ox/_esm/tempo/Transaction.js
/** Type to RPC Type mapping. */
var toRpcType = {
	...toRpcType$1,
	tempo: "0x76"
...
function fromRpc(transaction, _options = {}) {
	...
	if (transaction.signature) transaction_.signature = fromRpc$4(transaction.signature);
	...
	if (transaction.keyAuthorization) transaction_.keyAuthorization = fromRpc$2(transaction.keyAuthorization);
	if (transaction.feePayerSignature) {
		transaction_.feePayerSignature = fromRpc$5(transaction.feePayerSignature);
		transaction_.feePayerSignature.v = yParityToV(transaction_.feePayerSignature.yParity);
	}
	return transaction_;
}
//#endregion
//#region node_modules/ox/_esm/core/TransactionRequest.js
/**
...
function toRpc$1(request) {
	...
	if (typeof request.authorizationList !== "undefined") request_rpc.authorizationList = toRpcList$1(request.authorizationList);
	...
	if (typeof request.chainId !== "undefined") request_rpc.chainId = fromNumber(request.chainId);
	...
	if (typeof request.gas !== "undefined") request_rpc.gas = fromNumber(request.gas);
	if (typeof request.gasPrice !== "undefined") request_rpc.gasPrice = fromNumber(request.gasPrice);
	if (typeof request.maxFeePerBlobGas !== "undefined") request_rpc.maxFeePerBlobGas = fromNumber(request.maxFeePerBlobGas);
	if (typeof request.maxFeePerGas !== "undefined") request_rpc.maxFeePerGas = fromNumber(request.maxFeePerGas);
	if (typeof request.maxPriorityFeePerGas !== "undefined") request_rpc.maxPriorityFeePerGas = fromNumber(request.maxPriorityFeePerGas);
	if (typeof request.maxPriorityFeePerGas !== "undefined") request_rpc.maxPriorityFeePerGas = fromNumber(request.maxPriorityFeePerGas);
	if (typeof request.nonce !== "undefined") request_rpc.nonce = fromNumber(request.nonce);
	if (typeof request.to !== "undefined") request_rpc.to = request.to;
	if (typeof request.type !== "undefined") request_rpc.type = toRpcType$1[request.type] || request.type;
	if (typeof request.value !== "undefined") request_rpc.value = fromNumber(request.value);
	return request_rpc;
}
//#endregion
//#region node_modules/ox/_esm/tempo/TransactionRequest.js
/**
* Converts a {@link ox#TransactionRequest.TransactionRequest} to a {@link ox#TransactionRequest.Rpc}.
*
...
function toRpc(request) {
	...
	if (request.authorizationList) request_rpc.authorizationList = toRpcList(request.authorizationList);
	...
	if (typeof request.feeToken !== "undefined") request_rpc.feeToken = toAddress(request.feeToken);
	if (request.keyAuthorization) request_rpc.keyAuthorization = toRpc$2(request.keyAuthorization);
	if (typeof request.validBefore !== "undefined") request_rpc.validBefore = fromNumber(request.validBefore);
	if (typeof request.validAfter !== "undefined") request_rpc.validAfter = fromNumber(request.validAfter);
	const nonceKey = (() => {
		if (request.nonceKey === "random") return random(6);
		if (typeof request.nonceKey === "bigint") return fromNumber(request.nonceKey);
	})();
...
function fromTupleList(accessList) {
	...
	for (let i = 0; i < accessList.length; i++) {
		...
		if (address) assert$3(address, { strict: false });
		list.push({
			address,
			storageKeys: storageKeys.map((key) => validate(key) ? key : trimLeft(key))
		});
	}
	return list;
}
...
function toTupleList(accessList) {
	...
	for (const { address, storageKeys } of accessList) {
		for (let j = 0; j < storageKeys.length; j++) if (size(storageKeys[j]) !== 32) throw new InvalidStorageKeySizeError({ storageKey: storageKeys[j] });
		if (address) assert$3(address, { strict: false });
...
//#endregion
//#region node_modules/ox/_esm/core/TxEnvelope.js
/**
...
* ```
*/
var InvalidSerializedError = class extends BaseError$1 {
	constructor({ attributes, serialized, type }) {
		const missing = Object.entries(attributes).map(([key, value]) => typeof value === "undefined" ? key : void 0).filter(Boolean);
		super(`Invalid serialized transaction of type "${type}" was provided.`, { metaMessages: [`Serialized Transaction: "${serialized}"`, missing.length > 0 ? `Missing Attributes: ${missing.join(", ")}` : ""].filter(Boolean) });
		Object.defineProperty(this, "name", {
			enumerable: true,
			configurable: true,
			writable: true,
...
//#endregion
//#region node_modules/ox/_esm/tempo/TxEnvelopeTempo.js
...
function assert(envelope) {
	...
	if (typeof validBefore === "number" && typeof validAfter === "number" && validBefore <= validAfter) throw new InvalidValidityWindowError({
		validBefore,
		validAfter
	});
	if (calls) {
		for (const call of calls) if (call.to) assert$3(call.to, { strict: false });
	}
...
function deserialize(serialized) {
	const transactionArray = toHex$3(slice(serialized, 1));
	...
	if (!(transactionArray.length === 13 || transactionArray.length === 14 || transactionArray.length === 15)) throw new InvalidSerializedError({
		attributes: {
			authorizationList,
			chainId,
			maxPriorityFeePerGas,
	...
	if (validate$1(gas) && gas !== "0x") transaction.gas = BigInt(gas);
	if (validate$1(nonce)) transaction.nonce = nonce === "0x" ? 0n : BigInt(nonce);
	if (validate$1(maxFeePerGas) && maxFeePerGas !== "0x") transaction.maxFeePerGas = BigInt(maxFeePerGas);
	if (validate$1(maxPriorityFeePerGas) && maxPriorityFeePerGas !== "0x") transaction.maxPriorityFeePerGas = BigInt(maxPriorityFeePerGas);
	if (validate$1(nonceKey)) transaction.nonceKey = nonceKey === "0x" ? 0n : BigInt(nonceKey);
	if (validate$1(validBefore) && validBefore !== "0x") transaction.validBefore = Number(validBefore);
	if (validate$1(validAfter) && validAfter !== "0x") transaction.validAfter = Number(validAfter);
	if (validate$1(feeToken) && feeToken !== "0x") transaction.feeToken = feeToken;
	if (calls && calls !== "0x") transaction.calls = calls.map((callTuple) => {
	...
	if (accessList?.length !== 0 && accessList !== "0x") transaction.accessList = fromTupleList(accessList);
	if (authorizationList?.length !== 0 && authorizationList !== "0x") transaction.authorizationList = fromTupleList$1(authorizationList);
	if (feePayerSignatureOrSender !== "0x" && feePayerSignatureOrSender !== void 0) if (feePayerSignatureOrSender === "0x00" || validate$2(feePayerSignatureOrSender)) {
		transaction.feePayerSignature = null;
		if (validate$2(feePayerSignatureOrSender)) transaction.from = feePayerSignatureOrSender;
	} else transaction.feePayerSignature = fromTuple$2(feePayerSignatureOrSender);
	if (keyAuthorization) transaction.keyAuthorization = fromTuple(keyAuthorization);
	const signatureEnvelope = signature ? deserialize$1(signature) : void 0;
	if (signatureEnvelope) transaction = {
		...transaction,
		signature: signatureEnvelope
	};
	if (!transaction.from && signatureEnvelope) try {
...
function from(envelope, options = {}) {
	...
	if (envelope_.from) envelope_.from = resolve(envelope_.from);
	...
	return {
		...envelope_,
		...signature ? { signature: from$3(signature) } : {},
		...feePayerSignature ? { feePayerSignature: from$5(feePayerSignature) } : {},
		type: "tempo"
	};
}
/**
...
function serialize$1(envelope, options = {}) {
	...
	const feePayerSignatureOrSender = (() => {
		...
		if (options.format === "feePayer" && signature) {
			const sig = from$3(signature);
			if (sig.type === "keychain") return sig.userAddress;
			if (sig.type === "p256" || sig.type === "webAuthn") return fromPublicKey(sig.publicKey);
			if (sig.type === "secp256k1") return recoverAddress({
		...
		return toTuple$2(feePayerSignature);
	})();
	const serialized = [
		fromNumber(chainId),
		...
		...signature ? [serialize$2(from$3(signature))] : []
	];
	return concat$1(options.format === "feePayer" ? feePayerMagic : serializedType, fromHex$2(serialized));
}
/**
...
function getSignPayload(envelope, options = {}) {
	...
	if (options.from) return keccak256(concat$1("0x04", sigHash, resolve(options.from)));
	return sigHash;
}
/**
...
function hash(envelope, options = {}) {
	return keccak256(options.presign ? encodeForSigning(envelope) : serialize$1(envelope));
}
/**
...
* ```
*/
var CallsEmptyError = class extends BaseError$1 {
	constructor() {
...
* ```
*/
var InvalidValidityWindowError = class extends BaseError$1 {
...
//#endregion
//#region node_modules/viem/_esm/tempo/Abis.js
...
var tip403Registry = [
	...
	{
		name: "InvalidReceivePolicyType",
		type: "error",
		inputs: []
	},
	{
		name: "InvalidRecoveryAuthority",
		type: "error",
		inputs: []
	}
];
...
//#endregion
//#region node_modules/viem/_esm/tempo/Transaction.js
...
function isTempo(transaction) {
	try {
		return getType(transaction) === "tempo";
	} catch {
		return false;
	}
}
async function serialize(transaction, signature) {
	if (!isTempo(transaction)) {
		...
		if (signature && "type" in signature) {
			...
			return serializeTransaction$3(transaction, {
	...
	if (getType(transaction) === "tempo") return serializeTempo(transaction, signature);
...
async function serializeTempo(transaction, sig) {
	...
	if (signature && typeof transaction.feePayer === "object") {
		const tx = from(transaction_ox, { signature });
		const hash = getFeePayerSignPayload(tx, { sender: (() => {
			if (transaction.from) return transaction.from;
			if (signature.type === "secp256k1") return recoverAddress({
				payload: getSignPayload(tx),
				signature: signature.signature
			});
			throw new Error("Unable to extract sender from transaction or signature.");
		})() });
		return serialize$1(tx, { feePayerSignature: from$5(await transaction.feePayer.sign({ hash })) });
	}
	if (feePayer === true || !signature && hasPrefilledFeePayerSignature) {
		if (signature && feePayerSignature) return serialize$1(transaction_ox, { signature });
		if (signature) return serialize$1(transaction_ox, {
			format: "feePayer",
			sender: transaction.from,
			signature
		});
		return serialize$1(transaction_ox, { feePayerSignature: null });
	}
	return serialize$1({
		...transaction_ox,
...
//#endregion
//#region node_modules/viem/_esm/tempo/Account.js
...
async function signKeyAuthorization(account, parameters) {
	...
	const restrictions = admin ? {} : {
		expiry,
		limits,
		scopes
	};
	const hash = getSignPayload$1({
	...
	return from$1({
		address: accessKeyAddress,
		chainId,
		signature: from$3(isAccessKey ? await account.sign({
			hash,
			raw: true
...
function resolveAccessKey(accessKey) {
	if ("accessKeyAddress" in accessKey) return {
		accessKeyAddress: accessKey.accessKeyAddress,
		keyType: accessKey.keyType
	};
	if ("publicKey" in accessKey && accessKey.publicKey) return {
		accessKeyAddress: fromPublicKey(fromHex$3(accessKey.publicKey)),
...
//#endregion
//#region node_modules/viem/_esm/tempo/Addresses.js
var accountKeychain = "0xaAAAaaAA00000000000000000000000000000000";
var signatureVerifier = "0x5165300000000000000000000000000000000000";
//#endregion
//#region node_modules/viem/_esm/tempo/Hardfork.js
var hardforks = [
	"genesis",
	"t0",
	"t1",
...
//#endregion
//#region node_modules/viem/_esm/tempo/internal/utils.js
...
//#endregion
//#region node_modules/viem/_esm/tempo/actions/accessKey.js
/** @internal */
var signatureTypes = {
	0: "secp256k1",
	1: "p256",
...
(function(authorize) {
	...
	async function inner(action, client, parameters) {
		...
		const keyAuthorization = await signKeyAuthorization(parseAccount(account_), {
...
(function(burnWitness) {
	...
	*/
	...
	function extractEvent(logs) {
		...
		if (!log) throw new Error("`KeyAuthorizationWitnessBurned` event not found.");
		return log;
	}
...
async function getRemainingLimit(client, parameters) {
	...
	if (hardfork && lt(hardfork, "t3")) return {
		remaining: await readContract(client, {
			...rest,
	...
	*/
	function call(args) {
		...
		return defineCall({
			...
			args: [
				account,
				resolveAccessKeyAddress(accessKey),
				token
			]
		});
	}
...
//#endregion
//#region node_modules/viem/_esm/tempo/Formatters.js
function formatTransaction(transaction) {
	if (!isTempo(transaction)) return formatTransaction$1(transaction);
	const blockTimestamp = transaction.blockTimestamp == null ? void 0 : BigInt(transaction.blockTimestamp);
	const { feePayerSignature, gasPrice: _, nonce, ...tx } = fromRpc(transaction);
	return {
		...tx,
...
function formatTransactionRequest(r, action) {
	...
	const [keyType, keyData] = (() => {
		...
		if (type === "webAuthn") return ["webAuthn", "0x0578"];
		if (["p256", "secp256k1"].includes(type)) return [type, void 0];
	...
	return {
		...
		...keyId ? { keyId } : {},
		...keyType ? { keyType } : {},
		...typeof request.feePayer !== "undefined" ? { feePayer: typeof request.feePayer === "object" ? parseAccount(request.feePayer) : request.feePayer } : {},
...
function shimKeyData(data) {
	...
	return fromNumber(byteLength, { size: 2 });
}
//#endregion
//#region node_modules/viem/_esm/tempo/internal/concurrent.js
...
//#endregion
//#region node_modules/viem/_esm/tempo/chainConfig.js
...
var chainConfig = {
	...
	formatters: {
		...
		transactionReceipt: defineTransactionReceipt({ format: formatTransactionReceipt }),
		transactionRequest: defineTransactionRequest({ format: formatTransactionRequest })
	},
	prepareTransactionRequest: [async (r, { client, phase }) => {
		const request = r;
			...
			if (keyAuthorizationManager) {
				...
				if (typeof chainId !== "undefined") {
					...
					if (keyAuthorization) {
						...
						if (keyAuthorization.expiry != null && BigInt(keyAuthorization.expiry) <= now) await keyAuthorizationManager.remove(key);
						else {
							const metadata = await getAction(client, getMetadata, "getMetadata")({
								account: address,
								accessKey
							});
							if (isAddressEqual(metadata.address, accessKey) && !metadata.isRevoked && metadata.expiry > now) await keyAuthorizationManager.remove(key);
		...
		if (await (async () => {
			...
			const address = request.account?.address;
			if (address && typeof request.nonceKey === "undefined") return await detect(address);
			return false;
		})()) {
			request.nonceKey = maxUint256;
			request.nonce = 0;
			if (typeof request.validBefore === "undefined") request.validBefore = Math.floor(Date.now() / 1e3) + maxExpirySecs;
		} else if (typeof request.nonceKey !== "undefined") request.nonce = typeof request.nonce === "number" ? request.nonce : 0;
	...
	serializers: { transaction: ((transaction, signature) => serialize(transaction, signature)) },
	async verifyHash(client, parameters) {
		const { address, hash, signature, mode } = parameters;
		const envelope = (() => {
			if (typeof signature !== "string") return;
			try {
				return deserialize$1(signature);
			} catch {
				return;
			}
		})();
		if (envelope) {
			if (envelope?.type === "keychain" && mode === "allowAccessKey") {
				const innerPayload = envelope.version === "v2" ? keccak256$1(concat$1("0x04", hash, address)) : hash;
				...
				if (keyInfo.expiry <= BigInt(Math.floor(Date.now() / 1e3))) return false;
				return verify(envelope.inner, {
					address: accessKeyAddress,
					payload: innerPayload
				});
			}
			if (envelope.type === "p256" || envelope.type === "webAuthn") {
				...
				if (!code || code === "0xef01007702c00000000000000000000000000000000000") return verify(envelope, {
					address,
					payload: hash
				});
			}
		}
		return await getAction(client, verifyHash$1, "verifyHash")({
			...parameters,
			chain: null
		});
	}
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tempo.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tempoDevnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tempoLocalnet.js
var tempoLocalnet = /*#__PURE__*/ defineChain({
	...chainConfig,
	id: 1337,
	name: "Tempo",
	hardfork: "t3",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tempoModerato.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tenet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ternoa.js
var ternoa = /*#__PURE__*/ defineChain({
	id: 752025,
	name: "Ternoa",
	nativeCurrency: {
		name: "Capsule Coin",
	...
	rpcUrls: { default: { http: ["https://rpc-mainnet.zkevm.ternoa.network"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/thaiChain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/that.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/theta.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/thetaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/thunderCore.js
var thunderCore = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://mainnet-rpc.thundercore.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/thunderTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tiktrixTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tomb.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/treasure.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/treasureTopaz.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tron.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tronNile.js
var tronNile = /*#__PURE__*/ defineChain({
	id: 3448148188,
	name: "Tron Nile",
	nativeCurrency: {
		name: "TRON",
	...
	rpcUrls: { default: { http: ["https://nile.trongrid.io/jsonrpc"] } },
	blockExplorers: { default: {
		name: "Tronscan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/tronShasta.js
var tronShasta = /*#__PURE__*/ defineChain({
	id: 2494104990,
	name: "Tron Shasta",
	nativeCurrency: {
		name: "TRON",
	...
	rpcUrls: { default: { http: ["https://api.shasta.trongrid.io/jsonrpc"] } },
	blockExplorers: { default: {
		name: "Tronscan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ubiq.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ultra.js
var ultra = /*#__PURE__*/ defineChain({
	id: 19991,
	name: "Ultra EVM",
	nativeCurrency: {
		decimals: 18,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ultraTestnet.js
var ultraTestnet = /*#__PURE__*/ defineChain({
	id: 18881,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ultron.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/ultronTestnet.js
...
var unichain = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$8]: { address: "0x2F12d621a16e2d3285929C9996f478508951dFe4" } },
		portal: { [sourceId$8]: { address: "0x0bd48f6B86a26D3a217d0Fa6FfE2B491B956A7a2" } },
		l1StandardBridge: { [sourceId$8]: { address: "0x81014F44b0a345033bB2b3B21C7a1A308B35fEeA" } }
	},
	sourceId: sourceId$8
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/unichainSepolia.js
var sourceId$7 = 11155111;
var unichainSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		portal: { [sourceId$7]: { address: "0x0d83dab629f0e0F9d36c0Cbc89B69a489f0751bD" } },
		l1StandardBridge: { [sourceId$7]: { address: "0xea58fcA6849d79EAd1f26608855c2D6407d54Ce2" } },
		disputeGameFactory: { [sourceId$7]: { address: "0xeff73e5aa3B9AEC32c659Aa3E00444d20a84394b" } }
	},
	testnet: true,
	sourceId: sourceId$7
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/unique.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/uniqueOpal.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/uniqueQuartz.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/unreal.js
var unreal = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.unreal-orbit.gelato.digital"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/vana.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/vanaMoksha.js
var vanaMoksha = /*#__PURE__*/ defineChain({
	id: 14800,
	...
	rpcUrls: { default: { http: ["https://rpc.moksha.vana.org"] } },
	blockExplorers: { default: {
		name: "Vana Moksha Testnet",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/vanar.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/vechain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/velas.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/viction.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/victionTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/vision.js
var vision = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://infragrid.v.network/ethereum/compatible"] } },
	blockExplorers: { default: {
		name: "Vision Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/visionTestnet.js
var visionTestnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://vpioneer.infragrid.v.network/ethereum/compatible"] } },
	blockExplorers: { default: {
		name: "Vision Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/wanchain.js
var wanchain = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://gwan-ssl.wandevs.org:56891", "https://gwan2-ssl.wandevs.org"] } },
	blockExplorers: { default: {
		name: "WanScan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/wanchainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/weavevmAlphanet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/wemix.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/wemixTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/westendAssetHub.js
var westendAssetHub = /*#__PURE__*/ defineChain({
	id: 420420421,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/whitechain.js
var whitechain = /*#__PURE__*/ defineChain({
	testnet: false,
	name: "Whitechain",
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/whitechainTestnet.js
var whitechainTestnet = /*#__PURE__*/ defineChain({
	testnet: true,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/wmcTestnet.js
var wmcTestnet = /*#__PURE__*/ defineChain({
	id: 42070,
	name: "WMC Testnet",
	nativeCurrency: {
		name: "WMTx",
	...
	rpcUrls: { default: { http: ["https://rpc-testnet-base.worldmobile.net"] } },
	blockExplorers: { default: {
		name: "WMC Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/worldchain.js
var sourceId$6 = 1;
var worldchain = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$6]: { address: "0x069c4c579671f8c120b1327a73217D01Ea2EC5ea" } },
		l2OutputOracle: { [sourceId$6]: { address: "0x19A6d1E9034596196295CF148509796978343c5D" } },
		portal: { [sourceId$6]: { address: "0xd5ec14a83B7d95BE1E2Ac12523e2dEE12Cbeea6C" } },
		l1StandardBridge: { [sourceId$6]: { address: "0x470458C91978D2d929704489Ad730DC3E3001113" } }
	},
	testnet: false,
	sourceId: sourceId$6
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/worldchainSepolia.js
var sourceId$5 = 11155111;
var worldchainSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		disputeGameFactory: { [sourceId$5]: { address: "0x8Ec1111f67Dad6b6A93B3F42DfBC92D81c98449A" } },
		l2OutputOracle: { [sourceId$5]: { address: "0xc8886f8BAb6Eaeb215aDB5f1c686BF699248300e" } },
		portal: { [sourceId$5]: { address: "0xFf6EBa109271fe6d4237EeeD4bAb1dD9A77dD1A4" } },
		l1StandardBridge: { [sourceId$5]: { address: "0xd7DF54b3989855eb66497301a4aAEc33Dbb3F8DE" } }
	},
	testnet: true,
	sourceId: sourceId$5
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/worldLand.js
var worldLand = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://seoul.worldland.foundation"] } },
	blockExplorers: { default: {
		name: "WorldLand Scan",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xai.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xaiTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xdc.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xdcTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xgr.js
var xgr = /*#__PURE__*/ defineChain({
	id: 1643,
	name: "XGR Mainnet",
	nativeCurrency: {
		name: "XGR",
	...
	rpcUrls: { default: { http: ["https://rpc.xgr.network"] } },
	blockExplorers: { default: {
		name: "XGR Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xLayer.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xLayerTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xoneMainnet.js
var xoneMainnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://rpc.xone.org"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xoneTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xphereMainnet.js
var xphereMainnet = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://en-bkk.x-phere.com"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xphereTestnet.js
var xphereTestnet = /*#__PURE__*/ defineChain({
	id: 1998991,
	name: "Xphere Testnet",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["http://testnet.x-phere.com"] } },
	blockExplorers: { default: {
		name: "Xphere Tamsa Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xpla.js
var xpla = /*#__PURE__*/ defineChain({
	id: 37,
	name: "CONX Chain",
	nativeCurrency: {
		decimals: 18,
	...
	rpcUrls: { default: { http: ["https://dimension-evm-rpc.xpla.dev"] } },
	blockExplorers: { default: {
		name: "CONX Explorer",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xrOne.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xrplevm.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xrplevmDevnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xrplevmTestnet.js
var xrplevmTestnet = /*#__PURE__*/ defineChain({
	id: 1449e3,
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/xrSepolia.js
var xrSepolia = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://xr-sepolia-testnet.rpc.caldera.xyz/http"] } },
	blockExplorers: { default: {
		name: "Blockscout",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/yooldoVerse.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/yooldoVerseTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zenchainTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zeniq.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zeroNetwork.js
var zeroNetwork = /*#__PURE__*/ defineChain({
	id: 543210,
	name: "Zero Network",
	nativeCurrency: {
		name: "Ether",
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zetachain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zetachainAthensTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zhejiang.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zilliqa.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zilliqaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zircuit.js
var sourceId$4 = 1;
var zircuit = /*#__PURE__*/ defineChain({
	...
	rpcUrls: { default: { http: ["https://mainnet.zircuit.com"] } },
	blockExplorers: { default: {
	...
	contracts: {
		...chainConfig$3.contracts,
		multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" },
		l2OutputOracle: { [sourceId$4]: { address: "0x92Ef6Af472b39F1b363da45E35530c24619245A4" } },
		portal: { [sourceId$4]: { address: "0x17bfAfA932d2e23Bd9B909Fd5B4D2e2a27043fb1" } },
		l1StandardBridge: { [sourceId$4]: { address: "0x386B76D9cA5F5Fb150B6BFB35CF5379B22B26dd8" } }
	},
	testnet: false
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zircuitGarfieldTestnet.js
var sourceId$3 = 11155111;
var zircuitGarfieldTestnet = /*#__PURE__*/ defineChain({
	...chainConfig$3,
	id: 48898,
	...
	rpcUrls: { default: { http: ["https://garfield-testnet.zircuit.com/"] } },
	blockExplorers: { default: {
	...
	contracts: {
		...chainConfig$3.contracts,
		multicall3: { address: "0xcA11bde05977b3631167028862bE2a173976CA11" },
		l2OutputOracle: { [sourceId$3]: { address: "0xd69D3AC5CA686cCF94b258291772bc520FEAf211" } },
		portal: { [sourceId$3]: { address: "0x4E21A71Ac3F7607Da5c06153A17B1DD20E702c21" } },
		l1StandardBridge: { [sourceId$3]: { address: "0x87a7E2bCA9E35BA49282E832a28A6023904460D8" } }
	},
	testnet: true
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zkFair.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zkFairTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zkLinkNova.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zkLinkNovaSepoliaTestnet.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zksyncInMemoryNode.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zksyncLocalCustomHyperchain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zksyncLocalHyperchain.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zksyncLocalHyperchainL1.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zksyncLocalNode.js
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zkXPLA.js
var zkXPLA = /*#__PURE__*/ defineChain({
	id: 375,
	name: "zkXPLA Mainnet",
	network: "zkxpla",
	nativeCurrency: {
	...
	rpcUrls: { default: { http: ["https://rpc.zkxpla.io"] } },
	blockExplorers: { default: {
...
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zkXPLATestnet.js
var zkXPLATestnet = /*#__PURE__*/ defineChain({
	id: 475,
	name: "zkXPLA Testnet",
	...
	rpcUrls: { default: { http: ["https://testnet-rpc.zkxpla.io"] } },
	blockExplorers: { default: {
...
var zora = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		disputeGameFactory: { [sourceId$2]: { address: "0xB0F15106fa1e473Ddb39790f197275BC979Aa37e" } },
		l2OutputOracle: { [sourceId$2]: { address: "0x9E6204F750cD866b299594e2aC9eA824E2e5f95c" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
			blockCreated: 5882
		},
		portal: { [sourceId$2]: { address: "0x1a0ad011913A150f69f6A19DF447A0CfD9551054" } },
		l1StandardBridge: { [sourceId$2]: { address: "0x3e2Ea9B92B7E48A52296fD261dc26fd995284631" } }
	},
	sourceId: sourceId$2
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zoraSepolia.js
...
var zoraSepolia = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...chainConfig$3.contracts,
		l2OutputOracle: { [sourceId$1]: { address: "0x2615B481Bd3E5A1C0C7Ca3Da1bdc663E8615Ade9" } },
		multicall3: {
			address: "0xcA11bde05977b3631167028862bE2a173976CA11",
			blockCreated: 83160
		},
		portal: { [sourceId$1]: { address: "0xeffE2C6cA9Ab797D418f0D91eA60807713f3536f" } },
		l1StandardBridge: { [sourceId$1]: { address: "0x5376f1D543dcbB5BD416c56C189e4cB7399fCcCB" } }
	},
	sourceId: sourceId$1,
	testnet: true
});
//#endregion
//#region node_modules/viem/_esm/chains/definitions/zoraTestnet.js
var sourceId = 5;
var zoraTestnet = /*#__PURE__*/ defineChain({
	...
	contracts: {
		...
		portal: { [sourceId]: { address: "0xDb9F51790365e7dc196e7D072728df39Be958ACe" } }
	},
	sourceId,
	testnet: true
});
//#endregion
export { abey, abstract, abstractTestnet, acala, acria, adf, adi, agungTestnet, aioz, alephZero, alephZeroTestnet, alienx, alienxHalTestnet, alpenTestnet, ancient8, ancient8Sepolia, anvil, apeChain, apexTestnet, apollo, arbitrum, arbitrumGoerli, arbitrumNova, arbitrumSepolia, arc, arcTestnet, arenaz, areonNetwork, areonNetworkTestnet, areum, artelaTestnet, arthera, artheraTestnet, assetChain, assetChainTestnet, astar, astarZkEVM, astarZkyoto, atletaOlympia, aurora, auroraTestnet, auroria, autheoTestnet, avalanche, avalancheFuji, b3, b3Sepolia, bahamut, base, baseGoerli, basePreconf, baseSepolia, baseSepoliaPreconf, basecampTestnet, battlechainTestnet, beam, beamTestnet, bearNetworkChainMainnet, bearNetworkChainTestnet, berachain, berachainBepolia, berachainTestnet, berachainTestnetbArtio, bevmMainnet, bifrost, birdlayer, bitTorrent, bitTorrentTestnet, bitgert, bitkub, bitkubTestnet, bitlayer, bitlayerTestnet, bitrock, blast, blastSepolia, bob, bobSepolia, boba, bobaSepolia, boolBetaMainnet, botanix, botanixTestnet, bounceBit, bounceBitTestnet, bronos, bronosTestnet, bsc, bscGreenfield, bscTestnet, bsquared, bsquaredTestnet, btr, btrTestnet, bxn, bxnTestnet, cannon, canto, celo, celoAlfajores, celoSepolia, chang, chiliz, chips, citrea, citreaTestnet, classic, codex, codexTestnet, coinbit, coinex, confluxESpace, confluxESpaceTestnet, coreDao, coreTestnet1, coreTestnet2, corn, cornTestnet, cpchain, crab, creatorTestnet, creditCoin3Devnet, creditCoin3Mainnet, creditCoin3Testnet, cronos, cronosTestnet, cronoszkEVM, cronoszkEVMTestnet, crossbell, crossfi, curtis, cyber, cyberTestnet, dailyNetwork, dailyNetworkTestnet, darwinia, datahavenTestnet, dbkchain, dchain, dchainTestnet, defichainEvm, defichainEvmTestnet, degen, dfk, diode, disChain, dodochainTestnet, dogechain, domaTestnet, donatuz, dosChain, dosChainTestnet, dreyerxMainnet, dreyerxTestnet, dustboyIoT, dymension, eden, edexa, edexaTestnet, edgeless, edgelessTestnet, edgeware, edgewareTestnet, eduChain, eduChainTestnet, elastos, elastosTestnet, electroneum, electroneumTestnet, elysiumTestnet, energy, eni, eniTestnet, enuls, eon, eos, eosTestnet, eteria, etherlink, etherlinkShadownetTestnet, etherlinkTestnet, ethernity, etp, evmos, evmosTestnet, excelonMainnet, expanse, exsat, exsatTestnet, fantom, fantomSonicTestnet, fantomTestnet, fibo, filecoin, filecoinCalibration, filecoinHyperspace, fireChain, flame, flare, flareTestnet, flowMainnet, flowPreviewnet, flowTestnet, fluence, fluenceStage, fluenceTestnet, fluent, fluentDevnet, fluentTestnet, form, formTestnet, forma, formicarium, forta, foundry, fraxtal, fraxtalTestnet, funkiMainnet, funkiSepolia, fuse, fuseSparknet, fusion, fusionTestnet, garnet, gatechain, geist, genesys, gensyn, giwaSepolia, giwaSepoliaPreconf, glideL1Protocol, glideL2Protocol, gnosis, gnosisChiado, goChain, goat, gobi, godwoken, goerli, graphite, graphiteTestnet, gravity, gunz, guruNetwork, guruTestnet, ham, happychainTestnet, haqqMainnet, haqqTestedge2, hardhat, harmonyOne, hashkey, hashkeyTestnet, haustTestnet, hedera, hederaPreviewnet, hederaTestnet, hela, heliosTestnet, hemi, hemiSepolia, henesys, holesky, hoodi, horizenTestnet, hpb, hpp, hppSepolia, huddle01Mainnet, huddle01Testnet, humanity, humanityTestnet, humanode, humanodeTestnet5, hychain, hychainTestnet, hyperEvm, hyperEvm as hyperliquid, hyperliquidEvmTestnet, iSunCoin, icbNetwork, idchain, igra, immutableZkEvm, immutableZkEvmTestnet, inEVM, initVerse, initVerseGenesis, injective, injectiveTestnet, ink, inkSepolia, iota, iotaTestnet, iotex, iotexTestnet, jasmyChain, jasmyChainTestnet, jbc, jbcTestnet, jocMainnet, jocTestnet, jovay, jovaySepolia, juneo, juneoBCH1Chain, juneoDAI1Chain, juneoDOGE1Chain, juneoEUR1Chain, juneoGLD1Chain, juneoLINK1Chain, juneoLTC1Chain, juneoSGD1Chain, juneoSocotraTestnet, juneoUSD1Chain, juneoUSDT1Chain, juneomBTC1Chain, kaia, kairos, kakarotSepolia, kakarotStarknetSepolia, kardiaChain, karura, katana, kava, kavaTestnet, kcc, kii, kiiTestnetOro, kinto, klaytn, klaytnBaobab, koi, kroma, kromaSepolia, krown, l3x, l3xTestnet, lavita, lens, lensTestnet, lestnet, lightlinkPegasus, lightlinkPhoenix, linea, lineaGoerli, lineaSepolia, lineaTestnet, lisk, liskSepolia, loadAlphanet, localhost, loop, lukso, luksoTestnet, lumiaMainnet, lumiaTestnet, lumoz, lumozTestnet, luxeports, lycan, lyra, mainnet, mandala, manta, mantaSepoliaTestnet, mantaTestnet, mantle, mantleSepoliaTestnet, mantleTestnet, mantraDuKongEVMTestnet, mantraEVM, mapProtocol, matchain, matchainTestnet, mchVerse, megaeth, megaethTestnet, mekong, meld, memecore, merlin, merlinErigonTestnet, metachain, metachainIstanbul, metadium, metalL2, meter, meterTestnet, metis, metisGoerli, metisSepolia, mev, mevTestnet, mezo, mezoTestnet, mint, mintSepoliaTestnet, mitosisTestnet, mizuhikiTestnetAwaji, mode, modeTestnet, monad, monadTestnet, moonbaseAlpha, moonbeam, moonbeamDev, moonriver, morph, morphHolesky, morphSepolia, nahmii, nautilus, near, nearTestnet, neonDevnet, neonMainnet, neoxMainnet, neoxT4, newton, nexi, nexilix, nibiru, nitrographTestnet, nomina, oasisTestnet, oasys, odysseyTestnet, okc, omax, omni, omniOmega, oneWorld, oortMainnetDev, opBNB, opBNBTestnet, openledger, optimism, optimismGoerli, optimismSepolia, optopia, optopiaTestnet, orderly, orderlySepolia, otimDevnet, palm, palmTestnet, paseoPassetHub, peaq, pgn, pgnTestnet, phoenix, planq, plasma, plasmaDevnet, plasmaTestnet, playfiAlbireo, plinga, plume, plumeDevnet, plumeMainnet, plumeSepolia, plumeTestnet, polterTestnet, polygon, polygonAmoy, polygonMumbai, polygonZkEvm, polygonZkEvmCardona, polygonZkEvmTestnet, polynomial, polynomialSepolia, potos, potosTestnet, premiumBlockTestnet, pulsechain, pulsechainV4, pumpfiTestnet, pyrope, qMainnet, qTestnet, ql1, quai, quaiTestnet, radius, radiusTestnet, reactiveTestnet, real, redbellyMainnet, redbellyTestnet, reddio, reddioSepolia, redstone, rei, reyaNetwork, rise, riseTestnet, rivalz, rollux, rolluxTestnet, ronin, root, rootPorcini, rootstock, rootstockTestnet, rss3, rss3Sepolia, saakuru, saga, saigon, sanko, sapphire, sapphireTestnet, satoshiVM, satoshiVMTestnet, scroll, scrollSepolia, sei, seiTestnet, seismicDevnet, sentrix, sentrixTestnet, sepolia, shape, shapeSepolia, shardeum, shardeumSphinx, shibarium, shibariumTestnet, shiden, shimmer, shimmerTestnet, sidraChain, silentData, silicon, siliconSepolia, sixProtocol, skaleBase, skaleBaseSepoliaTestnet, skaleBlockBrawlers, skaleCalypso, skaleCalypsoTestnet, skaleCryptoBlades, skaleCryptoColosseum, skaleEuropa, skaleEuropaTestnet, skaleExorde, skaleHumanProtocol, skaleNebula, skaleNebulaTestnet, skaleRazor, skaleTitan, skaleTitanTestnet, sketchpad, snax, snaxTestnet, somnia, somniaTestnet, soneium, soneiumMinato, songbird, songbirdTestnet, sonic, sonicBlazeTestnet, sonicTestnet, sophon, sophonTestnet, sova, sovaSepolia, spicy, stable, stableTestnet, statusSepolia as statusNetworkSepolia, statusSepolia, step, story, storyAeneid, storyOdyssey, storyTestnet, stratis, subtensorEvm, superlumio, superposition, superseed, superseedSepolia, surgeTestnet, swan, swanProximaTestnet, swanSaturnTestnet, swellchain, swellchainTestnet, swissdlt, syscoin, syscoinTestnet, tac, tacSPB, taiko, taikoHekla, taikoHoodi, taikoJolnir, taikoKatla, taikoTestnetSepolia, taraxa, taraxaTestnet, teaSepolia, telcoinTestnet, telos, telosTestnet, tempo, tempo as tempoMainnet, tempoDevnet, tempoLocalnet, tempoModerato, tempoModerato as tempoTestnet, tenet, ternoa, thaiChain, that, theta, thetaTestnet, thunderCore, thunderTestnet, tiktrixTestnet, tomb, treasure, treasureTopaz, tron, tronNile, tronShasta, ubiq, ultra, ultraTestnet, ultron, ultronTestnet, unichain, unichainSepolia, unique, uniqueOpal, uniqueQuartz, unreal, vana, vanaMoksha, vanar, vechain, velas, viction, victionTestnet, vision, visionTestnet, wanchain, wanchainTestnet, weaveVMAlphanet, wemix, wemixTestnet, westendAssetHub, whitechain, whitechainTestnet, wmcTestnet, worldLand, worldchain, worldchainSepolia, xLayerTestnet as x1Testnet, xLayerTestnet, xLayer, xai, xaiTestnet, xdc, xdcTestnet, xgr, xoneMainnet, xoneTestnet, xphereMainnet, xphereTestnet, xpla, xrOne, xrSepolia, xrplevm, xrplevmDevnet, xrplevmTestnet, yooldoVerse, yooldoVerseTestnet, zenchainTestnet, zeniq, zeroG, zeroGGalileoTestnet, zeroGMainnet, zeroGTestnet, zeroNetwork, zetachain, zetachainAthensTestnet, zhejiang, zilliqa, zilliqaTestnet, zircuit, zircuitGarfieldTestnet, zkFair, zkFairTestnet, zkLinkNova, zkLinkNovaSepoliaTestnet, zksync as zkSync, zksync, zksyncInMemoryNode as zkSyncInMemoryNode, zksyncInMemoryNode, zksyncLocalNode as zkSyncLocalNode, zksyncLocalNode, zksyncSepoliaTestnet as zkSyncSepoliaTestnet, zksyncSepoliaTestnet, zkXPLA, zkXPLATestnet, zksyncLocalCustomHyperchain, zksyncLocalHyperchain, zksyncLocalHyperchainL1, zora, zoraSepolia, zoraTestnet };
