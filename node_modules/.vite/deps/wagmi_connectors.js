...
import { Ya as ResourceUnavailableRpcError, Za as SwitchChainError, Zo as parseAccount, ao as UserRejectedRequestError, hs as getAddress, ks as numberToHex, wt as withRetry } from "./writeContractSync-LaZFPBJH.js";
import { ct as withTimeout } from "./_esm-CNi-8Od0.js";
import { F as ProviderNotFoundError, Ft as ChainNotConfiguredError, h as createConnector, m as injected, p as mock, t as extractRpcUrls } from "./exports-1xzWy14p.js";
//#region node_modules/@wagmi/core/dist/esm/tempo/Connectors.js
...
function _setup(parameters) {
	return createConnector((config) => {
		...
		async function getAccountsModule() {
			return await import("./core-VbsuUiuH.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)).catch(() => {
		...
		async getProvider() {
			if (!walletProvider) {
				...
				const { createBaseAccountSDK } = await (() => {
					try {
						return import("./connectors-DcTEjIKL.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
					} catch {
		...
		async getProvider() {
			if (!walletProvider) {
				const { createCoinbaseWalletSDK } = await (() => {
					try {
						return import("./connectors-B1fLSvj4.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
					} catch {
			...
			if (!metamask) {
				if (!metamaskPromise) {
					const { createEVMClient } = await (async () => {
						try {
							return import("./connectors-B9CcdjcG.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
						} catch {
				...
				try {
					if (!accounts?.length && !isReconnecting) {
						const { RpcSchema } = await (() => {
							try {
								return import("./connectors-CNax4fdw.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
							} catch {
						...
						const { z } = await (() => {
							try {
								return import("./connectors-Ca1CTmdl.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
							} catch {
						...
						const res = await provider.request({
							method: "wallet_connect",
							params: [{
								..."capabilities" in rest ? { capabilities: z.encode(RpcSchema.wallet_connect.Capabilities, rest.capabilities ?? {}) } : {},
		...
		async getProvider() {
			...
			if (!provider_) {
				const { default: SDK } = await (() => {
					try {
						return import("./connectors-CMDOys_G.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
					} catch {
				...
				provider_ = new (await ((async () => {
					const Provider = await (() => {
						try {
							return import("./connectors-CUkMQnsi.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
						} catch {
		...
		async getProvider({ chainId } = {}) {
			async function initProvider() {
				...
				const { EthereumProvider } = await (() => {
					try {
						return import("./connectors-CGg3YBin.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
					} catch {
...
//#endregion
export { baseAccount, coinbaseWallet, injected, metaMask, mock, porto, safe, tempoWallet, version, walletConnect };
