import { $a as UnauthorizedProviderError, $o as createFilterRequestScope, $s as AbiDecodingZeroDataError, Ac as parseAbiParameter$1, As as stringToHex, At as AccountTypeNotSupportedError, Ba as InvalidRequestRpcError, Bn as isAddressEqual, Bo as decodeErrorResult, Bt as call, Cc as isHex, Cs as hexToBytes, Ct as receiptStatuses, Ds as boolToHex, Dt as sendRawTransaction, Es as toBytes, Et as sendTransaction, Fa as ChainDisconnectedError, Fn as getContractEvents, Fs as hexToNumber, Ga as ParseRpcError, Gc as isStructSignature, Gn as getTransactionError, Gt as encodeDeployData, Ha as LimitExceededRpcError, Hn as prepareTransactionRequest, Ht as withResolvers, Ia as DuplicateIdError, Ic as InvalidAbiParameterError, In as getLogs, Io as etherUnits, It as poll, Ja as ResourceNotFoundRpcError, Jo as solidityError, Ka as ProviderDisconnectedError, Kc as modifiers, La as InternalRpcError, Ln as parseEventLogs, Lo as gweiUnits, Ls as trim, Lt as wait, Ma as AtomicReadyWalletRejectedUpgradeError, Mt as uninstallFilter, Na as AtomicityNotSupportedError, Ns as hexToBigInt, Nt as getFilterChanges, Oa as toRlp, Os as bytesToHex, Ot as assertCurrentChain, P as secp256k1, Pa as BundleTooLargeError, Pn as decodeFunctionResult, Pt as getBlockNumber, Q as hashTypedData, Qa as TransactionRejectedRpcError, Qo as createContractEventFilter, Ra as InvalidInputRpcError, Rn as decodeEventLog, Rt as observe, Sc as size$1, St as formatTransactionReceipt, Tc as getAction, Ts as stringToBytes, Tt as writeContract, Ua as MethodNotFoundRpcError, Un as fillTransaction, Us as pad, Ut as getCallError, Va as JsonRpcVersionUnsupportedError, Vn as estimateGas, Vo as decodeAbiParameters, Vt as createBatchScheduler, Wa as MethodNotSupportedRpcError, Wn as getChainId, Wt as getChainContractAddress, Xn as commitmentToVersionedHash, Xs as AbiConstructorParamsNotFoundError, Ya as ResourceUnavailableRpcError, Yo as encodeFunctionData, Ys as AbiConstructorNotFoundError, Za as SwitchChainError, Zo as parseAccount, Zt as deploylessCallViaBytecodeBytecode, _ as validate, _o as RawContractError, _s as InvalidAddressError, a as watchBlockNumber, ao as UserRejectedRequestError, ar as estimateFeesPerGas, as as bytesRegex, bc as BaseError, bo as isAbortError, bt as getCode, c as NotFoundError, co as RpcRequestError, cr as getBlock, d as getSelector$1, da as extract, dn as universalResolverResolveAbi, do as WebSocketRequestError, en as multicall3Bytecode, eo as UnknownBundleIdError, es as encodeEventTopics, et as getTypesForEIP712Domain, f as getTransactionReceipt, fa as getNodeError, fc as BytesSizeMismatchError, fn as universalResolverReverseAbi, fs as concatHex, g as unwrap, gs as LruMap, hn as concat$1, hs as getAddress, i as waitForTransactionReceipt, io as UnsupportedProviderMethodError, ir as formatBlockParameter, is as arrayRegex, ja as getContractError, js as toHex, jt as watchContractEvent, ka as recoverAddress, kc as parseStructs, ks as numberToHex, kt as AccountNotFoundError, l as from$2, la as formatTransactionRequest, ln as multicall3Abi, lo as SocketClosedError, ls as sliceHex, lt as ripemd160$1, m as parseTransaction, mc as DecodeLogTopicsMismatch, mo as ContractFunctionRevertedError, mr as BlockNotFoundError, ms as checksumAddress, mt as serializeTransaction, n as sendTransactionSync, nc as AbiEncodingLengthMismatchError, nn as batchGatewayAbi, no as UnsupportedChainIdError, nt as validateTypedData, o as verifyHash$1, oo as WalletConnectSessionSettlementError, or as estimateMaxPriorityFeePerGas, os as integerRegex, ot as hashMessage, p as getTransaction, pa as ExecutionRevertedError, pc as DecodeLogDataMismatch, pn as toRpc, ps as isAddress, qo as createCursor, r as sendRawTransactionSync, ro as UnsupportedNonOptionalCapabilityError, rr as getTransactionCount, rs as encodeAbiParameters, sa as serializeStateOverride, so as HttpRequestError, sr as getGasPrice, ss as slice, t as writeContractSync, tn as addressResolverAbi, to as UnknownRpcError, tt as serializeTypedData, u as fromAbi$2, un as textResolverAbi, uo as TimeoutError, ur as formatBlock, us as concat, v as wrap, vo as getAbortError, vr as assertRequest, wa as UnknownNodeError, wt as withRetry, xs as keccak256, yc as UnsupportedPackedAbiType, z as encode$2, za as InvalidParamsRpcError, zn as formatLog, zo as stringify, zt as readContract } from "./writeContractSync-LaZFPBJH.js";
import { t as ccipRequest } from "./ccip-Dz9OrR9i.js";
...
function encode$1(type, value, isArray = false) {
	...
	if (arrayMatch && Array.isArray(value)) {
		...
		const data = [];
		for (let i = 0; i < value.length; i++) data.push(encode$1(childType, value[i], true));
...
function encode(...parameters) {
	...
	return concat$1(bytecode, abiConstructor.inputs?.length && args?.length ? encode$2(abiConstructor.inputs, args) : "0x");
}
/** @internal */
...
//#endregion
export { serializeErc6492Signature as $, deployContract as A, EnsInvalidChainIdError as At, zeroAddress as B, BundleFailedError as Bt, watchAsset as C, getEnsResolver as Ct, showCallsStatus as D, EnsAvatarInvalidNftUriError as Dt, signMessage as E, getEnsText as Et, watchPendingTransactions as F, rpcSchema as Ft, parseGwei as G, getTransactionConfirmations as H, simulateContract as Ht, watchBlocks as I, WaitForCallsStatusTimeoutError as It, InvalidDecimalNumberError as J, parseEther as K, verifyTypedData as L, waitForCallsStatus as Lt, testActions as M, labelhash as Mt, createPublicClient as N, namehash as Nt, sendCallsSync as O, EnsAvatarUnsupportedNamespaceError as Ot, publicActions as P, createClient as Pt, serializeErc8010Signature as Q, verifyMessage as R, getCallsStatus as Rt, walletActions as S, getBalance as St, signTransaction as T, getEnsAvatar as Tt, getStorageAt as U, parseAbiParameter as Ut, multicall as V, getContract as Vt, getProof as W, verifyMessage$1 as X, verifyTypedData$1 as Y, verifyHash as Z, fallback as _, isBytes as _t, parseCompactSignature as a, isErc6492Signature as at, createTransport as b, getBlockTransactionCount as bt, defineKzg as c, withTimeout as ct, fromBlobs as d, ripemd160 as dt, recoverTypedDataAddress as et, decodeDeployData as f, extractChain as ft, UrlRequiredError as g, getCreateAddress as gt, http as h, getCreate2Address as ht, parseSignature as i, isErc8010Signature as it, createTestClient as j, getEnsAddress as jt, getCapabilities as k, EnsAvatarUriResolutionError as kt, toCoinType as l, createNonceManager as lt, webSocket as m, getContractAddress as mt, serializeCompactSignature as n, parseErc8010Signature as nt, compactSignatureToSignature as o, zeroHash as ot, ProviderRpcError as p, ccipReadTunnel as pt, parseUnits as q, recoverTransactionAddress as r, parseErc6492Signature as rt, setupKzg as s, rpc as st, signatureToCompactSignature as t, recoverMessageAddress as tt, sidecarsToVersionedHashes as u, nonceManager as ut, shouldThrow as v, encodePacked as vt, signTypedData as w, getEnsName as wt, createWalletClient as x, getBlobBaseFee as xt, custom as y, getFeeHistory as yt, ethAddress as z, sendCalls as zt };

//# sourceMappingURL=_esm-CNi-8Od0.js.map